...
(function() {
		...
		CKEDITOR.event || (CKEDITOR.event = function() {}, CKEDITOR.event.implementOn = function(a) {
			...
			return {
				...
				on: function(b, c, h, k, l) {
					...
					var w = this,
						B = d.call(this, b);
					if (0 > B.getListenerIndex(c)) {
						B = B.listeners;
						h || (h = this);
						isNaN(l) && (l = 10);
						q.fn = c;
						q.priority = l;
						for (var y = B.length - 1; 0 <= y; y--)
							if (B[y].priority <= l) return B.splice(y + 1, 0, q), {
								removeListener: f
							};
						B.unshift(q)
					}
						...
						if (w) {
							...
							if (y.length)
								for (var y = y.slice(0),
										F, r = 0; r < y.length; r++) {
									if (w.errorProof) try {
										F = y[r].call(this, f, q, e, k)
									} catch (m) {} else F = y[r].call(this, f, q, e, k);
									F === a ? d = 1 : "undefined" != typeof F && (q = F);
									if (c || d) break
								}
						}
						q = d ? !1 : "undefined" == typeof q ? !0 : q;
						c = l;
						d = B;
						return q
					}
				...
				removeListener: function(a, c) {
					var d = b(this)[a];
					if (d) {
						var k = d.getListenerIndex(c);
						0 <= k && d.listeners.splice(k, 1)
					}
				},
		...
		function a(a, b, c) {
			...
			this.input = function() {
				...
				if (!f._scheduledTimer || !1 !== f._reschedule()) {
					var w = (new Date).getTime() - f._lastOutput;
					w < f._minInterval ? f._scheduledTimer = setTimeout(a, f._minInterval - w) : a()
				}
			}
		}
		...
		CKEDITOR.tools = {
			...
			buildStyleHtml: function(a) {
				...
				for (var b, c = [], f = 0; f < a.length; f++)
					if (b = a[f]) /@import|[{}]/.test(b) ? c.push("\x3cstyle\x3e" + b + "\x3c/style\x3e") : (b = CKEDITOR.appendTimestamp(b), c.push('\x3clink type\x3d"text/css" rel\x3dstylesheet href\x3d"' + b + '"\x3e'));
				return c.join("")
			},
			...
			transformPlainTextToHtml: function(a, b) {
				var c = b == CKEDITOR.ENTER_BR,
					...
					k = b == CKEDITOR.ENTER_P ? "p" : "div";
				if (!c) {
					var m = /\n{2}/g;
					if (m.test(f)) var l = "\x3c" + k + "\x3e",
						e = "\x3c/" + k + "\x3e",
						f = l + f.replace(m, function() {
							return e +
								l
						}) + e
				}
				f = f.replace(/\n/g, "\x3cbr\x3e");
				c || (f = f.replace(new RegExp("\x3cbr\x3e(?\x3d\x3c/" + k + "\x3e)"), function(a) {
			...
			normalizeCssText: function(a, b) {
				var c = [],
					f, k = CKEDITOR.tools.parseCssText(a, !0, b);
				for (f in k) c.push(f + ":" + k[f]);
				c.sort();
			...
			parseCssText: function(a, b, c) {
				...
				if (!a || ";" == a) return f;
				a.replace(/&quot;/g, '"').replace(/\s*([^:;\s]+)\s*:\s*([^;]+)\s*(?=;|$)/g, function(a, c, w) {
					b && (c = c.toLowerCase(), "font-family" == c && (w = w.replace(/\s*,\s*/g, ",")), w = CKEDITOR.tools.trim(w));
					f[c] = w
				});
				return f
			},
			...
			convertArrayToObject: function(a, b) {
				...
				for (var f = 0, k = a.length; f < k; ++f) c[a[f]] = b;
				return c
			},
			...
			enableHtml5Elements: function(a, b) {
				for (var c = "abbr article aside audio bdi canvas data datalist details figcaption figure footer header hgroup main mark meter nav output progress section summary time video".split(" "), f = c.length, k; f--;) k = a.createElement(c[f]), b && a.appendChild(k)
			},
			...
			keystrokeToArray: function(a, b) {
				var c = b & 16711680,
					...
					m = [],
					l = [];
				c & CKEDITOR.CTRL && (m.push(k ? "⌘" : a[17]), l.push(k ? a[224] : a[17]));
				c & CKEDITOR.ALT && (m.push(k ? "⌥" : a[18]), l.push(a[18]));
				c & CKEDITOR.SHIFT &&
					(m.push(k ? "⇧" : a[16]), l.push(a[16]));
				f && (a[f] ? (m.push(a[f]), l.push(a[f])) : (m.push(String.fromCharCode(f)), l.push(String.fromCharCode(f))));
				return {
					display: m,
					aria: l
				}
			...
			getCookie: function(a) {
				a = a.toLowerCase();
				for (var b = document.cookie.split(";"), c, f, k = 0; k < b.length; k++)
					if (c = b[k].split("\x3d"), f = decodeURIComponent(CKEDITOR.tools.trim(c[0]).toLowerCase()), f === a) return decodeURIComponent(1 < c.length ?
						c[1] : "");
				return null
			},
			...
			escapeCss: function(a) {
				if (a)
					if (window.CSS && CSS.escape) a = CSS.escape(a);
						...
						a = String(a);
						for (var b = a.length, c = -1, f, k = "", m = a.charCodeAt(0); ++c < b;) f = a.charCodeAt(c), k = 0 == f ? k + "�" : 127 == f || 1 <= f && 31 >= f || 0 == c && 48 <= f && 57 >= f || 1 == c && 48 <= f && 57 >= f && 45 == m ? k + ("\\" + f.toString(16) + " ") : 0 == c && 1 == b && 45 == f ? k + ("\\" + a.charAt(c)) : 128 <= f || 45 == f || 95 == f || 48 <= f && 57 >= f || 65 <= f && 90 >= f || 97 <= f && 122 >= f ? k + a.charAt(c) : k + ("\\" + a.charAt(c));
						a = k
					}
				else a = "";
				return a
			...
			normalizeMouseButton: function(a, b) {
				...
				for (var c = [
					...
					var k = c[f];
					if (k[0] === a && b) return k[1];
					if (!b && k[1] === a) return k[0]
				}
			},
			convertHexStringToBytes: function(a) {
				var b = [],
					c = a.length / 2,
					f;
				for (f = 0; f < c; f++) b.push(parseInt(a.substr(2 *
					f, 2), 16));
				return b
			},
			convertBytesToBase64: function(a) {
				...
				for (f = 0; f < c; f += 3) {
					...
					l[0] = (k[0] & 252) >> 2;
					l[1] = (k[0] & 3) << 4 | k[1] >> 4;
					l[2] = (k[1] & 15) << 2 | (k[2] & 192) >> 6;
					l[3] = k[2] & 63;
					for (e = 0; 4 > e; e++) b = e <= m ? b + "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/".charAt(l[e]) : b + "\x3d"
				}
				return b
			},
			style: {
			...
			array: {
				filter: function(a, b, c) {
					var f = [];
					this.forEach(a, function(k, m) {
						b.call(c, k, m, a) && f.push(k)
					});
					return f
				},
				find: function(a, b, c) {
					for (var f = a.length, k = 0; k < f;) {
						if (b.call(c, a[k], k, a)) return a[k];
						k++
					}
				},
				forEach: function(a, b, c) {
					var f = a.length,
						k;
					for (k = 0; k < f; k++) b.call(c, a[k], k, a)
				},
				map: function(a, b, c) {
					for (var f = [], k = 0; k < a.length; k++) f.push(b.call(c, a[k], k, a));
					return f
				},
				reduce: function(a,
					b, c, f) {
					for (var k = 0; k < a.length; k++) c = b.call(f, c, a[k], k, a);
					return c
				},
			...
			object: {
				...
				keys: function(a) {
					...
					for (var k in a) c.push(k);
					if (CKEDITOR.env.ie &&
						9 > CKEDITOR.env.version)
						for (k = 0; k < f.length; k++) b.call(a, f[k]) && c.push(f[k]);
					return c
				},
				...
				merge: function(a, b) {
					var c = CKEDITOR.tools,
						f = c.clone(a),
						k = c.clone(b);
					c.array.forEach(c.object.keys(k), function(a) {
						f[a] = "object" === typeof k[a] && "object" === typeof f[a] ? c.object.merge(f[a], k[a]) : k[a]
					});
					return f
				}
			},
			getAbsoluteRectPosition: function(a, b) {
				...
				c(a.getFrame());
				var k = CKEDITOR.document.getWindow().getScrollPosition();
				f.top += k.y;
				f.left += k.x;
				"x" in f && "y" in f && (f.y += k.y, f.x += k.x);
			...
			statics: {
				...
				splitCssValues: function(a, b) {
					...
					var c = CKEDITOR.tools.array.reduce(["width", "style", "color"], function(c, f) {
						var k = a["border-" + f] || b[f];
						c[f] = k ? CKEDITOR.tools.style.parse.sideShorthand(k) : null;
						return c
					}, {});
					return CKEDITOR.tools.array.reduce(["top", "right", "bottom", "left"], function(b, f) {
						...
						b["border-" + f] = new CKEDITOR.tools.style.border(k);
						return b
					}, {})
				}
			}
	...
	CKEDITOR.tools.extend(CKEDITOR.dom.document.prototype, {
		...
		getByAddress: function(a, d) {
			for (var b = this.$.documentElement, c = 0; b && c < a.length; c++) {
				var g = a[c];
				if (d)
					for (var e = -1, h = 0; h < b.childNodes.length; h++) {
		...
		CKEDITOR.tools.extend(CKEDITOR.dom.element.prototype, {
			...
			breakParent: function(a, b) {
				...
				if (CKEDITOR.env.ie && !CKEDITOR.env.edge) {
					for (c = new CKEDITOR.dom.element("div"); e = f.getFirst();) e.$.style.backgroundColor && (e.$.style.backgroundColor = e.$.style.backgroundColor), c.append(e);
					c.insertAfter(this);
					c.remove(!0)
				...
				function a(b, c, f) {
					if (c && c.type == CKEDITOR.NODE_ELEMENT) {
						for (var e = []; c.data("cke-bookmark") || c.isEmptyInlineRemoveable();)
							if (e.push(c), c = f ? c.getNext() : c.getPrevious(), !c || c.type != CKEDITOR.NODE_ELEMENT) return;
						if (b.isIdentical(c)) {
							for (var k = f ? b.getLast() : b.getFirst(); e.length;) e.shift().move(b, !f);
							c.moveChildren(b, !f);
							c.remove();
			...
			removeStyle: function(a) {
				...
				if (b.removeProperty || "border" != a && "margin" != a && "padding" != a) b.removeProperty ? b.removeProperty(a) : b.removeAttribute(CKEDITOR.tools.cssStyleToDomStyle(a)), this.$.style.cssText || this.removeAttribute("style");
					...
					for (var b = [], e = 0; e < c.length; e++)
						if (f)
							for (var d =
									0; d < f.length; d++) b.push([a, c[e], f[d]].join("-"));
			...
			getDocumentPosition: function(a) {
				...
				if (document.documentElement.getBoundingClientRect && (CKEDITOR.env.ie ?
					...
					var g = this.$.getBoundingClientRect(),
						h = f.$.documentElement,
						r = h.clientTop || e.$.clientTop || 0,
						m = h.clientLeft || e.$.clientLeft || 0,
						L = !0;
					CKEDITOR.env.ie && (L = f.getDocumentElement().contains(this), f = f.getBody().contains(this), L = d && f || !d && L);
					L && (CKEDITOR.env.webkit || CKEDITOR.env.ie && 12 <= CKEDITOR.env.version ? (b = e.$.scrollLeft || h.scrollLeft, c = e.$.scrollTop || h.scrollTop) : (c = d ? e.$ : h, b = c.scrollLeft, c = c.scrollTop), b = g.left + b - m, c = g.top + c - r)
				} else
					for (r = this, m = null; r && "body" != r.getName() &&
						...
						m = r;
						r = (g = r.$.offsetParent) ? new CKEDITOR.dom.element(g) : null
					}
				a && (g = this.getWindow(), r = a.getWindow(), !g.equals(r) && g.$.frameElement && (a = (new CKEDITOR.dom.element(g.$.frameElement)).getDocumentPosition(a), b += a.x, c += a.y));
			...
			scrollIntoParent: function(a, b, c) {
				...
				function r(a, b) {
					...
					f = a.getWindow();
					f.equals(b) || (f = r(CKEDITOR.dom.element.get(f.$.frameElement), b), c.x += f.x, c.y += f.y);
					return c
				}
				...
				a instanceof CKEDITOR.dom.window && (a = L ? d.getBody() : d.getDocumentElement());
				...
				var G = a.$.clientHeight,
					p = a.$.clientWidth;
				d = e.x - m(this, "left") - v.x || 0;
				g = e.y - m(this, "top") - v.y || 0;
				f = e.x + f + m(this, "right") - (v.x + p) || 0;
				e = e.y + J + m(this, "bottom") - (v.y + G) || 0;
				(0 > g || 0 < e) && h(0, !0 === b ? g : !1 === b ? e : 0 > g ? g : e);
				c && (0 > d || 0 < f) && h(0 > d ? d : f, 0)
			},
			...
			copyAttributes: function(a, b) {
				...
				for (var f = 0; f < c.length; f++) {
					var e = c[f],
						...
						g;
					if (!(d in b))
						if ("checked" == d && (g = this.getAttribute(d))) a.setAttribute(d, g);
						else if (!CKEDITOR.env.ie || this.hasAttribute(d)) g = this.getAttribute(d), null === g && (g = e.nodeValue), a.setAttribute(d, g)
				}
				"" !== this.$.style.cssText &&
			...
			getEditor: function(a) {
				...
				a = a || void 0 === a;
				for (c in b)
					if (f = b[c], f.element.equals(this) && f.elementMode != CKEDITOR.ELEMENT_MODE_APPENDTO || !a && (e = f.editable()) && (e.equals(this) || e.contains(this))) return f;
				return null
			},
			find: function(a) {
				var c = d(this);
			...
			forEach: function(a, b, c) {
				...
				if (!1 !== f) {
					c = this.getChildren();
					for (var e = 0; e < c.count(); e++) f = c.getItem(e), f.type == CKEDITOR.NODE_ELEMENT ? f.forEach(a, b) : b && f.type != b || a(f)
				}
			},
			fireEventHandler: function(a, b) {
				...
				if (CKEDITOR.env.ie && 9 > CKEDITOR.env.version) {
					var e = f.ownerDocument.createEventObject(),
						d;
					for (d in b) e[d] = b[d];
					f.fireEvent(c,
						e)
	...
	(function() {
		function a(a, b) {
			...
			if (!a && !this._.guardLTR) {
				var q = f.type == CKEDITOR.NODE_ELEMENT ? f : f.getParent(),
					E = f.type == CKEDITOR.NODE_ELEMENT ? f.getChild(g) : f.getNext();
			...
			if (a && !this._.guardRTL) {
				var z = e.type == CKEDITOR.NODE_ELEMENT ? e : e.getParent(),
					t = e.type == CKEDITOR.NODE_ELEMENT ? d ? e.getChild(d - 1) : null : e.getPrevious();
				this._.guardRTL = function(a, b) {
					return (!b || !z.equals(a)) && (!t || !a.equals(t)) && (a.type != CKEDITOR.NODE_ELEMENT || !b || !a.equals(c.root))
				}
			}
			var D = a ? this._.guardRTL : this._.guardLTR;
			w = k ? function(a, b) {
				return !1 === D(a, b) ? !1 : k(a, b)
			} : D;
			this.current ? f = this.current[l](!1, h, w) : (a ? f.type == CKEDITOR.NODE_ELEMENT &&
				(f = 0 < g ? f.getChild(g - 1) : !1 === w(f, !0) ? null : f.getPreviousSourceNode(!0, h, w)) : (f = e, f.type == CKEDITOR.NODE_ELEMENT && ((f = f.getChild(d)) || (f = !1 === w(e, !0) ? null : e.getNextSourceNode(!0, h, w)))), f && !1 === w(f) && (f = null));
			for (; f && !this._.end;) {
				this.current = f;
		...
		CKEDITOR.dom.walker.bookmark = function(a, b) {
			...
			return function(f) {
				var e, d;
				e = f && f.type != CKEDITOR.NODE_ELEMENT && (d = f.getParent()) && c(d);
				e = a ? e : e || c(f);
				return !!(b ^ e)
			}
		};
		...
		var g = /^[\t\r\n ]*(?:&nbsp;|\xa0)$/,
			...
			l = function(a) {
				return h(a) || e(a) || a.type == CKEDITOR.NODE_ELEMENT && a.is(CKEDITOR.dtd.$inline) && !a.is(CKEDITOR.dtd.$empty)
			};
		...
		var f = CKEDITOR.dom.walker.empty(),
			w = CKEDITOR.dom.walker.validEmptyBlockContainers = CKEDITOR.tools.extend(function(a) {
				var b = {},
					c;
		...
		CKEDITOR.dom.walker.editable = function(a) {
			return function(b) {
				b =
					q(b) ? !1 : b.type == CKEDITOR.NODE_TEXT || b.type == CKEDITOR.NODE_ELEMENT && (b.is(CKEDITOR.dtd.$inline) || b.is("hr") || "false" == b.getAttribute("contenteditable") || !CKEDITOR.env.needsBrFiller && b.is(w) && f(b)) ? !0 : !1;
				return !!(a ^ b)
			}
		};
	...
	(function() {
		...
		function d(a, b, c, e, d) {
			function g(a, b, c, f) {
				var Q = c ? a.getPrevious() : a.getNext();
				if (f && h) return Q;
				q || f ? b.append(a.clone(!0, d), c) : (a.remove(), l && b.append(a, c));
				return Q
			}

			function m() {
				var a, b, c, f = Math.min(N.length, x.length);
				for (a = 0; a < f; a++)
					if (b = N[a], c = x[a], !b.equals(c)) return a;
				return a - 1
			}
			...
			var p = a.startContainer,
				...
				E = a.endOffset,
				z, t, D, C, I, T;
			if (q && u.type == CKEDITOR.NODE_TEXT && (p.equals(u) || p.type === CKEDITOR.NODE_ELEMENT && p.getFirst().equals(u))) c.append(a.document.createText(u.substring(K, E)));
			else {
				u.type == CKEDITOR.NODE_TEXT ? q ? T = !0 : u = u.split(E) : 0 < u.getChildCount() ? E >= u.getChildCount() ? (u = u.getChild(E - 1), t = !0) : u = u.getChild(E) : C = t = !0;
				p.type == CKEDITOR.NODE_TEXT ? q ? I = !0 : p.split(K) : 0 < p.getChildCount() ? 0 === K ? (p = p.getChild(K), z = !0) : p = p.getChild(K - 1) : D = z = !0;
				for (var N = p.getParents(), x = u.getParents(), H = m(),
						M = N.length - 1, n = x.length - 1, A = c, Q, aa, X, ea = -1, V = H; V <= M; V++) {
					aa = N[V];
					X = aa.getNext();
					for (V != M || aa.equals(x[V]) && M < n ? b && (Q = A.append(aa.clone(0, d))) : z ? g(aa, A, !1, D) : I && A.append(a.document.createText(aa.substring(K))); X;) {
						if (X.equals(x[V])) {
							ea = V;
							break
						}
				...
				A = c;
				for (V = H; V <= n; V++)
					if (c = x[V], X = c.getPrevious(), c.equals(N[V])) b && (A = A.getChild(0));
					else {
						V != n || c.equals(N[V]) && n < M ? b && (Q = A.append(c.clone(0, d))) : t ? g(c, A, !1, C) : T && A.append(a.document.createText(c.substring(0, E)));
						if (V > ea)
							for (; X;) X = g(X, A, !0);
						A = Q
					} q ||
		...
		function c(a) {
			...
			return function(e) {
				return c(e) || b(e) ? !0 : !a && h(e) || e.type == CKEDITOR.NODE_ELEMENT && e.is(CKEDITOR.dtd.$removeEmpty)
			}
		}
		...
		CKEDITOR.dom.range.prototype = {
			...
			createBookmark: function(a) {
				...
				g.setHtml("\x26nbsp;");
				a && (k = "cke_bm_" + CKEDITOR.tools.getNextNumber(), g.setAttribute("id", k + (d ? "C" : "S")));
				d || (m = g.clone(), m.setHtml("\x26nbsp;"), a && m.setAttribute("id", k + "E"), h = this.clone(), b(e) && (e = b(e),
					h.moveToPosition(e, CKEDITOR.POSITION_AFTER_END)), h.collapse(), h.insertNode(m));
				h = this.clone();
				b(c) && (e = b(c), h.moveToPosition(e, CKEDITOR.POSITION_BEFORE_START));
				h.collapse(!0);
				h.insertNode(g);
				m ? (this.setStartAfter(g), this.setEndBefore(m)) : this.moveToPosition(g, CKEDITOR.POSITION_AFTER_END);
				return {
					startNode: a ? k + (d ? "C" : "S") : g,
					endNode: a ? k + "E" : m,
					serializable: a,
					collapsed: d
				}
			...
			createBookmark2: function() {
				function a(b) {
					...
					d = f;
					var g = e;
					d = d.type != CKEDITOR.NODE_ELEMENT || 0 === g || g == d.getChildCount() ?
						0 : d.getChild(g - 1).type == CKEDITOR.NODE_TEXT && d.getChild(g).type == CKEDITOR.NODE_TEXT;
					d && (f = f.getChild(e - 1), e = f.getLength());
					if (f.type == CKEDITOR.NODE_ELEMENT && 0 < e) {
						a: {
							for (d = f; e--;)
								if (g = d.getChild(e).getIndex(!0), 0 <= g) {
									e = g;
									break a
								} e = -1
						}
					...
					if (f.type == CKEDITOR.NODE_TEXT) {
						d = f;
						for (g = 0;
							(d = d.getPrevious()) && d.type == CKEDITOR.NODE_TEXT;) g += d.getText().replace(CKEDITOR.dom.selection.FILLING_CHAR_SEQUENCE, "").length;
						d = g;
						f.isEmpty() ? (g = f.getPrevious(c), d ? (e = d, f = g ? g.getNext() : f.getParent().getFirst()) : (f = f.getParent(),
				...
				function b(a, c) {
					...
					if (f) {
						var e = a.container;
						f.equals(e) && (a.offset -= CKEDITOR.dom.selection.FILLING_CHAR_SEQUENCE.length, 0 >= a.offset && (a.offset = e.getIndex(), a.container = e.getParent()))
					}
				}
			...
			enlarge: function(a, b) {
				...
				function e(a, b, c) {
					var f = new CKEDITOR.dom.range(c);
					f.setStart(a, b);
				...
				switch (a) {
					...
					case CKEDITOR.ENLARGE_ELEMENT:
						...
						z.type == CKEDITOR.NODE_TEXT ? (t && (z = !CKEDITOR.tools.trim(z.substring(0, t)).length && z, E = !!z), z && ((u = z.getPrevious()) || (p = z.getParent()))) : (t && (u = z.getChild(t - 1) || z.getLast()), u || (p = z));
						for (p = c(p); p ||
							u;) {
							if (p && !u) {
								!K && p.equals(h) && (K = !0);
								if (k ? p.isBlockBoundary() : !m.contains(p)) break;
								E && "inline" == p.getComputedStyle("display") || (E = !1, K ? q = p : this.setStartBefore(p));
								u = p.getPrevious()
							}
							for (; u;)
								if (z = !1, u.type == CKEDITOR.NODE_COMMENT) u = u.getPrevious();
								else {
									if (u.type == CKEDITOR.NODE_TEXT) g = u.getText(), d.test(g) && (u = null), z = /[\s\ufeff]$/.test(g);
										...
										if (E && CKEDITOR.dtd.$removeEmpty[u.getName()]) {
											...
											if (d.test(g)) u =
												...
												for (var t = u.$.getElementsByTagName("*"), D = 0, C; C = t[D++];)
													if (!CKEDITOR.dtd.$removeEmpty[C.nodeName.toLowerCase()]) {
														u = null;
														break
													} u && (z = !!g.length)
										} else u = null;
									z && (E ? K ? q = p : p && this.setStartBefore(p) : E = !0);
									if (u) {
										z = u.getPrevious();
										if (!p && !z) {
											p = u;
						...
						p = u = null;
						K = E = !1;
						z.type == CKEDITOR.NODE_TEXT ? CKEDITOR.tools.trim(z.substring(t)).length ? E = !0 : (E = !z.getLength(), t == z.getLength() ? (u = z.getNext()) || (p = z.getParent()) : e(z,
							t, m) && (p = z.getParent())) : (u = z.getChild(t)) || (p = z);
						for (; p || u;) {
							if (p && !u) {
								!K && p.equals(h) && (K = !0);
								if (k ? p.isBlockBoundary() : !m.contains(p)) break;
								E && "inline" == p.getComputedStyle("display") || (E = !1, K ? l = p : p && this.setEndAfter(p));
								u = p.getNext()
							}
							for (; u;) {
								z = !1;
								if (u.type == CKEDITOR.NODE_TEXT) g = u.getText(), e(u, 0, m) || (u = null), z = /^[\s\ufeff]/.test(g);
									...
									if ((0 < u.$.offsetWidth || b && u.is("br")) && !u.data("cke-bookmark"))
										if (E && CKEDITOR.dtd.$removeEmpty[u.getName()]) {
											...
											if (d.test(g)) u =
												...
												for (t = u.$.getElementsByTagName("*"), D = 0; C = t[D++];)
													if (!CKEDITOR.dtd.$removeEmpty[C.nodeName.toLowerCase()]) {
														u = null;
														break
													} u && (z = !!g.length)
						...
						q && l && (h = q.contains(l) ? l : q, this.setStartBefore(h), this.setEndAfter(h));
						break;
					case CKEDITOR.ENLARGE_BLOCK_CONTENTS:
					case CKEDITOR.ENLARGE_LIST_ITEM_CONTENTS:
						p = new CKEDITOR.dom.range(this.root);
						m = this.root;
						p.setStartAt(m,
							CKEDITOR.POSITION_AFTER_START);
						p.setEnd(this.startContainer, this.startOffset);
						p = new CKEDITOR.dom.walker(p);
						var I, T, N = CKEDITOR.dom.walker.blockBoundary(a == CKEDITOR.ENLARGE_LIST_ITEM_CONTENTS ? {
								br: 1
							} : null),
							x = null,
							H = function(a) {
						...
						I = I || m;
						this.setStartAt(I,
							!I.is("br") && (!p && this.checkStartOfBlock() || p && I.contains(p)) ? CKEDITOR.POSITION_AFTER_START : CKEDITOR.POSITION_AFTER_END);
						...
						p = this.clone();
						p.collapse();
						p.setEndAt(m, CKEDITOR.POSITION_BEFORE_END);
						p = new CKEDITOR.dom.walker(p);
						p.guard =
						...
						p = p.lastForward();
						I = I || m;
						this.setEndAt(I, !p && this.checkEndOfBlock() || p && I.contains(p) ? CKEDITOR.POSITION_BEFORE_END : CKEDITOR.POSITION_BEFORE_START);
			...
			splitBlock: function(a, b) {
				...
				"br" !=
				a && (d || (d = this.fixBlock(!0, a), g = (new CKEDITOR.dom.elementPath(this.endContainer, this.root)).block), g || (g = this.fixBlock(!1, a)));
				c = d && this.checkStartOfBlock();
				e = g && this.checkEndOfBlock();
				this.deleteContents();
				d && d.equals(g) && (e ? (m = new CKEDITOR.dom.elementPath(this.startContainer, this.root), this.moveToPosition(g, CKEDITOR.POSITION_AFTER_END), g = null) : c ? (m = new CKEDITOR.dom.elementPath(this.startContainer, this.root), this.moveToPosition(d, CKEDITOR.POSITION_BEFORE_START), d = null) : (g = this.splitElement(d, b ||
			...
			removeEmptyBlocksAtEnd: function() {
				...
				var b = CKEDITOR.dom.walker.whitespaces(),
					c = CKEDITOR.dom.walker.bookmark(!1);
				return function(b) {
					for (var c = this.createBookmark(), e = this[b ? "endPath" : "startPath"](), d = e.block || e.blockLimit, g; d && !d.equals(e.root) && !d.getFirst(a(d));) g = d.getParent(), this[b ? "setEndAt" : "setStartAt"](d, CKEDITOR.POSITION_AFTER_END), d.remove(1), d = g;
					this.moveToBookmark(c)
				}
			}(),
			startPath: function() {
			...
			checkStartOfBlock: function(a) {
				var c = this.startContainer,
					e = this.startOffset;
				CKEDITOR.env.ie && e && c.type == CKEDITOR.NODE_TEXT && (c = CKEDITOR.tools.ltrim(c.substring(0, e)), k.test(c) && this.trim(0, 1));
				a || this.trim();
			...
			checkEndOfBlock: function(a) {
				var c = this.endContainer,
					e = this.endOffset;
				CKEDITOR.env.ie && c.type == CKEDITOR.NODE_TEXT && (c = CKEDITOR.tools.rtrim(c.substring(e)), k.test(c) && this.trim(1, 0));
				a || this.trim();
			...
			moveToElementEditablePosition: function(a, b) {
				...
				for (var c = 0; a;) {
					...
					var e = a,
						d = c,
						g = void 0;
					e.type == CKEDITOR.NODE_ELEMENT && e.isEditable(!1) && (g = e[b ? "getLast" : "getFirst"](q));
					d || g || (g = e[b ? "getPrevious" : "getNext"](q));
					a = g
				}
				return !!c
			},
			...
			getClientRects: function() {
				function a(b, c) {
					...
					g && d.setStart(c.startContainer.getParent(),
					...
					if (d = CKEDITOR.tools.array.map(d, function(a) {
						...
						function b(d) {
							CKEDITOR.tools.array.forEach(e, function(b, f) {
								var g = CKEDITOR.tools.objectCompare(a[d], b);
								g || (g = CKEDITOR.tools.objectCompare(a.widgetRect, b));
								g && (Array.prototype.splice.call(e, f, a.length - d, a.widgetRect), c = !0)
							});
			...
			_find: function(a, b) {
				...
				if (c && c.find)
					for (m = c.find(a), g = 0; g < m.count(); g++)
						if (c = m.getItem(g), b || !c.isReadOnly()) h = c.getPosition(e.startNode) & CKEDITOR.POSITION_FOLLOWING || e.startNode.equals(c), k = c.getPosition(e.endNode) & CKEDITOR.POSITION_PRECEDING + CKEDITOR.POSITION_IS_CONTAINED ||
		...
		CKEDITOR.dom.range.mergeRanges = function(a) {
			return CKEDITOR.tools.array.reduce(a, function(a, b) {
				...
				if (c) {
					...
					for (d = e.next(); f(d) || b.endContainer.equals(d);) d = e.next();
					e = !d
				}
		...
		a.prototype = {
			getNextParagraph: function(a) {
				...
				if (!this._.started) {
					...
					h = r.startPath();
					var m = r.endPath(),
						L = !r.collapsed && c(r, h.block),
						v = !r.collapsed && c(r, m.block, 1);
					r.shrink(CKEDITOR.SHRINK_ELEMENT, !0);
					L && r.setStartAt(h.block, CKEDITOR.POSITION_BEFORE_END);
					v && r.setEndAt(m.block, CKEDITOR.POSITION_AFTER_START);
					h = r.endContainer.hasAscendant("pre", !0) || r.startContainer.hasAscendant("pre", !0);
					...
					r.collapsed || (h = new CKEDITOR.dom.walker(r.clone()), m = CKEDITOR.dom.walker.bookmark(!0, !0), h.evaluator = m, this._.nextNode = h.next(), h = new CKEDITOR.dom.walker(r.clone()), h.evaluator = m, h = h.previous(), this._.lastNode = h.getNextSourceNode(!0, null, r.root), this._.lastNode && this._.lastNode.type == CKEDITOR.NODE_TEXT && !CKEDITOR.tools.trim(this._.lastNode.getText()) && this._.lastNode.getParent().isBlockBoundary() && (m = this.range.clone(), m.moveToPosition(this._.lastNode, CKEDITOR.POSITION_AFTER_END), m.checkEndOfBlock() &&
						(m = new CKEDITOR.dom.elementPath(m.endContainer, m.root), this._.lastNode = (m.block || m.blockLimit).getNextSourceNode(!0))), this._.lastNode && r.root.contains(this._.lastNode) || (this._.lastNode = this._.docEndMarker = r.document.createText(""), this._.lastNode.insertAfter(h)), r = null);
					this._.started = 1;
					h = r
				}
				m = this._.nextNode;
				...
				for (this._.nextNode = null; m;) {
					var L = 0,
						...
						G = 0;
					if (J) m.type == CKEDITOR.NODE_TEXT && g.test(m.getText()) && (J = 0);
					else {
						var p = m.getName();
						if (CKEDITOR.dtd.$block[p] && "false" == m.getAttribute("contenteditable")) {
							...
							b(this, a, d);
							break
						} else if (m.isBlockBoundary(this.forceBrBreak && !v && {
								br: 1
							})) {
							if ("br" == p) J = 1;
							else if (!h && !m.getChildCount() && "hr" != p) {
								d = m;
								B = m.equals(r);
								break
							}
							h && (h.setEndAt(m, CKEDITOR.POSITION_BEFORE_START), "br" != p && (this._.nextNode = m));
							L = 1
						} else {
							if (m.getFirst()) {
					...
					J && h.setEndAt(m, CKEDITOR.POSITION_AFTER_END);
					m = this._getNextSourceNode(m, G, r);
					if ((B = !m) || L && h) break
				}
				if (!d) {
				...
				F && (y = d.getLast()) && y.type == CKEDITOR.NODE_ELEMENT && "br" == y.getName() && (!CKEDITOR.env.needsBrFiller || y.getPrevious(e) || y.getNext(e)) && y.remove();
				this._.nextNode || (this._.nextNode = B || d.equals(r) || !r ? null : this._getNextSourceNode(d, 1, r));
				return d
			},
	...
	CKEDITOR.config = {
		...
		width: "",
		baseFloatZIndex: 1E4,
		blockedKeystrokes: [CKEDITOR.CTRL + 66, CKEDITOR.CTRL + 73, CKEDITOR.CTRL +
			85
		]
	};
	(function() {
		function a(a, b, c, e, d) {
			...
			for (g in b) {
				...
				for (x in T) {
					...
					var m = n,
						...
						H = void 0;
					k ? I = !1 : k = {};
					for (H in E) "!" == H.charAt(0) && (H = H.slice(1), A.push(H), k[H] = !0, I = !1);
					for (; H = A.pop();) E[H] = E["!" +
						H], delete E["!" + H];
					m[C] = (I ? !1 : k) || null
				}
			...
			for (e = a.length; c < e; ++c) {
				...
				for (x in N) {
					...
					k = [];
					E = void 0;
					for (E in C) - 1 < E.indexOf("*") ? k.push(new RegExp("^" + E.replace(/\*/g, ".*") + "$")) : k.push(E);
					C = k;
					C.length && (n[t] = C, m = !1)
				}
				n.nothingRequired = m;
				n.noProperties = !(n.attributes || n.classes || n.styles);
				if (!0 === g.elements || null ===
					g.elements) d[f ? "unshift" : "push"](g);
				else
					for (z in n = g.elements, delete g.elements, n)
						if (b[z]) b[z][f ? "unshift" : "push"](g);
						else b[z] = [g]
			}
		}
		...
		function c(a, b, c) {
			if (!a.match || a.match(b)) {
				...
				b = b.classes;
				if (a) {
					for (var e = !1, d = !0 === a, f = b.length; f--;)
						if (d || a(b[f])) b.splice(f, 1), e = !0;
					a = e
				} else a = !1;
		...
		function h(a, b) {
			if (!a) return !1;
			if (!0 === a) return a;
			if ("string" == typeof a) return a = C(a), "*" == a ? !0 : CKEDITOR.tools.convertArrayToObject(a.split(b));
			...
			if (d = a.requiredClasses)
				for (g = b.classes, c = 0; c < d.length; ++c)
					if (e = d[c], "string" == typeof e) {
						if (-1 == CKEDITOR.tools.indexOf(g, e)) return !1
					} else if (!CKEDITOR.tools.checkIfAnyArrayItemMatches(g, e)) return !1;
		...
		function f(a) {
			var b, c, e, d, g = {},
				f = 1;
			for (a = C(a); b = a.match(x);)(c = b[2]) ? (e = w(c, "styles"), d = w(c, "attrs"), c = w(c, "classes")) : e = d = c = null, g["$" + f++] = {
				elements: b[1],
				classes: c,
				styles: e,
				attributes: d
		...
		function y(a, b, e, g) {
			var f = 0,
				t;
			g.toHtml && (b.name = b.name.replace(M, "$1"));
			if (g.doCallbacks && a.elementCallbacks) {
				a: {
					t = a.elementCallbacks;
					for (var h = 0, x = t.length, C; h < x; ++h)
						if (C = t[h](b)) {
							t = C;
							break a
						} t = void 0
			...
			if (g.doTransform && (t = a._.transformations[b.name])) {
				B(b);
				for (h = 0; h < t.length; ++h) p(a, b, t[h]);
				r(b)
			}
			if (g.doFilter) {
				a: {
					...
					if (a || t) {
						B(b);
						if (h)
							for (k = 0, E = h.length; k < E; ++k)
								if (!1 === c(h[k], b, D)) {
									a = null;
									break a
								} if (x)
							for (k = 0, E = x.length; k < E; ++k) c(x[k], b, D);
						if (a)
							for (k = 0, E = a.length; k < E; ++k) d(a[k], b, D, C);
						if (t)
							for (k = 0, E = t.length; k < E; ++k) d(t[k], b, D, C);
						a = D
					} else a = null
				}
				...
				var h = b.attributes,
					I = b.styles,
					x = b.classes;C = b.classBackup;
				var N = b.styleBackup,
					H, z, l = [],
					D = [],
					T = /^data-cke-/;k = !1;delete h.style;delete h["class"];delete b.classBackup;delete b.styleBackup;
				if (!a.allAttributes)
					for (H in h) E[H] || (T.test(H) ? H == (z = H.replace(/^data-cke-saved-/, "")) || E[z] || (delete h[H], k = !0) : (delete h[H], k = !0));
				if (!a.allStyles || a.hadInvalidStyle) {
					for (H in I) a.allStyles || A[H] ? l.push(H + ":" + I[H]) : k = !0;
					l.length && (h.style = l.sort().join("; "))
				} else N && (h.style = N);
				if (!a.allClasses ||
					a.hadInvalidClass) {
					for (H = 0; H < x.length; ++H)(a.allClasses || t[x[H]]) && D.push(x[H]);
					D.length && (h["class"] = D.sort().join(" "));
					C && D.length < C.split(/\s+/).length && (k = !0)
				} else C && (h["class"] = C);k && (f = 1);
				if (!g.skipFinalValidation && !m(b)) return e.push(b),
				1
			}
			g.toHtml && (b.name = b.name.replace(n, "cke:$1"));
			return f
		}
		...
		function G(a, b, c) {
			var e = a.name;
			if (t.$empty[e] || !a.children.length) "hr" == e && "br" == b ? a.replaceWith(v()) : (a.parent && c.push({
				check: "it",
				el: a.parent
			}), a.remove());
			else if (t.$block[e] || "tr" == e)
				if ("br" == b) a.previous && !J(a.previous) && (b = v(), b.insertBefore(a)), a.next && !J(a.next) && (b = v(), b.insertAfter(a)), a.replaceWithChildren();
				else {
					var e = a.children,
						d;
					b: {
						d = t[b];
						for (var g = 0, f = e.length, n; g < f; ++g)
							if (n = e[g], n.type == CKEDITOR.NODE_ELEMENT && !d[n.name]) {
								d = !1;
								break b
							} d = !0
					}
					if (d) a.name = b, a.attributes = {}, c.push({
						...
						d = a.parent;
						for (var g = d.type == CKEDITOR.NODE_DOCUMENT_FRAGMENT || "body" == d.name, h, x, f = e.length; 0 < f;) n = e[--f], g && (n.type == CKEDITOR.NODE_TEXT || n.type == CKEDITOR.NODE_ELEMENT && t.$inline[n.name]) ? (h || (h = new CKEDITOR.htmlParser.element(b), h.insertAfter(a), c.push({
							check: "parent-down",
							el: h
						})), h.add(n, 0)) : (h = null, x = t[d.name] || t.span, n.insertAfter(a), d.type == CKEDITOR.NODE_DOCUMENT_FRAGMENT || n.type != CKEDITOR.NODE_ELEMENT || x[n.name] || c.push({
							check: "el-up",
							el: n
						}));
						a.remove()
		...
		function u(a, b) {
			...
			for (g in e)
				if ("class" == g)
					for (c = e[g].split(/\s+/), n = a.classes.join("|"); t = c.pop();) {
						if (-1 == n.indexOf(t)) return !1
					} else if (a.attributes[g] != e[g]) return !1;
			for (f in d)
				if (a.styles[f] !=
					d[f]) return !1;
			return !0
		...
		CKEDITOR.filter.prototype = {
			allow: function(b, c, d) {
				...
				if ("string" == typeof b) b = f(b);
					...
					for (g = 0; g < b.length; ++g) n = this.allow(b[g], c, d);
					return n
				}
			...
			applyTo: function(a, b, c, e) {
						...
						a: {
							...
							if (f)
								for (C = 0; C < f.length; ++C)
									if ((m = e.match(f[C])) && m[0].length == e.length) {
										c = !0;
										break a
				...
				for (var D; c = g.pop();) c.type == CKEDITOR.NODE_ELEMENT ? G(c, e, a) : c.remove();
				for (; C = a.pop();)
					if (c = C.el, c.parent) switch (D = t[c.parent.name] || t.span, C.check) {
						case "it":
							t.$removeEmpty[c.name] && !c.children.length ? G(c, e, a) : m(c) || G(c, e, a);
							break;
						case "el-up":
							c.parent.type ==
								CKEDITOR.NODE_DOCUMENT_FRAGMENT || D[c.name] || G(c, e, a);
							break;
						case "parent-down":
							c.parent.type == CKEDITOR.NODE_DOCUMENT_FRAGMENT || D[c.name] || G(c.parent, e, a)
					}
				return h
			},
				...
				if (!this.disabled && a) {
					...
					for (d = 0; d < a.length; ++d) {
						...
						var g = void 0,
							...
							x = void 0;
						c = [];
						for (f = 0; f < b.length; ++f) n = b[f], "string" == typeof n ? (n = n.split(/\s*:\s*/), t = n[0], h = null, x = n[1]) : (t = n.check, h = n.left, x = n.right), g || (g = n, g = g.element ? g.element : t ? t.match(/^([a-z0-9]+)/i)[0] :
							g.left.getDefinition().element), h instanceof CKEDITOR.style && (h = E(h)), c.push({
							check: t == g ? null : t,
							left: h,
							right: "string" == typeof x ? z(x) : x
						});
						b = g;
						e[b] || (e[b] = []);
						e[b].push(c)
			...
			check: function(a, b, c) {
				...
				if ("string" == typeof a) {
					...
					n && (d.attributes.style = CKEDITOR.tools.writeCssText(d.styles))
				} else d = a.getDefinition(), n = d.styles, e = d.attributes || {}, n && !CKEDITOR.tools.isEmpty(n) ? (n = D(n), e.style = CKEDITOR.tools.writeCssText(n, !0)) : n = {}, d = {
					name: d.element,
					attributes: e,
				...
				var n = CKEDITOR.tools.clone(d),
					t = [],
					h;
				if (!1 !== b && (h = this._.transformations[d.name])) {
					for (e =
						0; e < h.length; ++e) p(this, d, h[e]);
					r(d)
				}
				y(this, n, t, {
					doFilter: !0,
				...
				0 < t.length ? c = !1 : ((b = d.attributes["class"]) && (d.attributes["class"] = d.attributes["class"].split(" ").sort().join(" ")), c = CKEDITOR.tools.objectCompare(d.attributes, n.attributes, !0), b && (d.attributes["class"] = b));
		...
		var T = {
			...
			A;
		A = CKEDITOR.filter.transformationsTools = {
			...
			transform: function(a, b) {
				if ("string" == typeof b) a.name = b;
					...
					for (g in d)
						if ("class" ==
							g)
							for (c = a.classes.join("|"), n = d[g].split(/\s+/); t = n.pop();) - 1 == c.indexOf(t) && a.classes.push(t);
						else a.attributes[g] = d[g];
					for (f in e) a.styles[f] = e[f]
				}
			}
		}
	})();
		...
		return {
			load: function(b, c, g, e) {
				...
				var k = b.length,
					...
					f = [],
					w = function(a) {
						c && (h ? c.call(g, a) : c.call(g, q, f))
					};
				if (0 === l) w(!0);
				else {
					var B = function(a, b) {
							(b ? q : f).push(a);
							0 >= --l && (e && CKEDITOR.document.getDocumentElement().removeStyle("cursor"), w(b))
						},
						y = function(b, c) {
							a[b] = 1;
							var e = d[b];
							...
							if (a[b]) B(b, !0);
								...
								if (!(1 < e.length)) {
									...
									c && (CKEDITOR.env.ie && (8 >= CKEDITOR.env.version || CKEDITOR.env.ie9Compat) ? g.$.onreadystatechange = function() {
										if ("loaded" == g.$.readyState || "complete" == g.$.readyState) g.$.onreadystatechange = null, y(b, !0)
									} : (g.$.onload = function() {
										setTimeout(function() {
											g.$.onload = null;
											g.$.onerror = null;
	...
	CKEDITOR.resourceManager.prototype = {
		...
		load: function(a, d, b) {
			...
			for (var c = this.loaded, g = this.registered, e = [], h = {}, k = {}, l = 0; l < a.length; l++) {
				var q = a[l];
				if (q)
					if (c[q] || g[q]) k[q] = this.get(q);
					else {
			...
			CKEDITOR.scriptLoader.load(e,
				function(a, e) {
					...
					for (var g = 0; g < a.length; g++)
						for (var f = h[a[g]], l = 0; l < f.length; l++) {
							var m = f[l];
							k[m] = this.get(m);
							c[m] = 1
						}
				...
				h = function(b) {
					a.call(this, b, function(a) {
						...
						for (f in a) {
							...
							if (!d[f]) {
								if (k.icons)
									for (var y = k.icons.split(","), F = y.length; F--;) CKEDITOR.skin.addIcon(y[F], k.path + "icons/" + (CKEDITOR.env.hidpi && k.hidpi ? "hidpi/" : "") + y[F] + ".png");
								k.isSupportedEnvironment = k.isSupportedEnvironment || function() {
									return !0
								};
								d[f] = 1
							}
						...
						if (b.length) h.call(this, b);
							...
							for (f in e) k = e[f], k.onLoad && !k.onLoad._called && (!1 === k.onLoad() && delete e[f], k.onLoad._called = 1);
							c && c.call(g || window, e)
						}
					}, this)
				};
	...
	(function() {
		function a(a, g, f) {
			...
			CKEDITOR.tools.setTimeout(function() {
				this.isDestroyed() || this.isDetached() || k(this, a)
			}, 0, this)
		}
		...
		function e(a, b, c) {
			if (b) {
				...
				for (d in g) e = g[d], (c || e.contextSensitive) && e.refresh(a, b)
			}
		}
		...
		function w(a) {
			...
			var c = a.config,
				...
				d = b(c.extraPlugins),
				g = b(c.removePlugins);
			if (d) var f = new RegExp("(?:^|,)(?:" + d.replace(/,/g, "|") + ")(?\x3d,|$)", "g"),
				e = e.replace(f, ""),
				e = e + ("," + d);
			if (g) var h = new RegExp("(?:^|,)(?:" +
					g.replace(/,/g, "|") + ")(?\x3d,|$)", "g"),
				e = e.replace(h, "");
			...
			CKEDITOR.plugins.load(e.split(","), function(b) {
				...
				for (var f in b) {
					var k = b[f],
						...
						x = k.requires,
						H;
					CKEDITOR.tools.isArray(x) && (x = x.join(","));
					if (x && (H = x.match(h)))
						for (; x = H.pop();) CKEDITOR.error("editor-plugin-required", {
							plugin: x.replace(",", ""),
							requiredBy: f
						});
					l && !a.lang[f] && (l.split && (l = l.split(",")), 0 <= CKEDITOR.tools.indexOf(l, a.langCode) ?
						N = a.langCode : (N = a.langCode.replace(/-.*/, ""), N = N != a.langCode && 0 <= CKEDITOR.tools.indexOf(l, N) ? N : 0 <= CKEDITOR.tools.indexOf(l, "en") ? "en" : l[0]), k.langEntries && k.langEntries[N] ? (a.lang[f] = k.langEntries[N], N = null) : g.push(CKEDITOR.getUrl(k.path + "lang/" + N + ".js")));
					d.push(N);
					e.push(k)
				}
				CKEDITOR.scriptLoader.load(g, function() {
					if (!a.isDestroyed() && !a.isDetached()) {
						for (var b = ["beforeInit", "init", "afterInit"], g = 0; g < b.length; g++)
							for (var f = 0; f < e.length; f++) {
								var h = e[f];
								0 === g && d[f] && h.lang && h.langEntries && (a.lang[h.name] =
									h.langEntries[d[f]]);
								if (h[b[g]]) h[b[g]](a)
							}
		...
		function y(a, b) {
			function c(a) {
				var b = a.startContainer,
					...
					d = b.is && b.is("tr"),
					g = b.is && b.is("td");
				a = g && b.equals(e) && a.endOffset === b.getChildCount();
				b = g && 1 === b.getChildCount() && "img" === b.getChildren().getItem(0).getName();
				return d || a && !b ? !0 : !1
			}
			...
			for (var d = new CKEDITOR.dom.documentFragment, g, f, h, k = 0; k < a.length; k++) {
				var z = a[k],
					t = z.startContainer.getAscendant("tr",
						!0);
				c(z) ? (g || (g = t.getAscendant("table").clone(), g.append(t.getAscendant({
					thead: 1,
					tbody: 1,
					tfoot: 1
				}).clone()), d.append(g), g = g.findOne("thead, tbody, tfoot")), f && f.equals(t) || (f = t, h = t.clone(), g.append(h)), h.append(e(z))) : d.append(z.cloneContents())
			}
		...
		CKEDITOR.tools.extend(CKEDITOR.editor.prototype, {
			...
			extractSelectedHtml: function(a,
				...
				for (g = 0; g < e.length; g++) d.append(c.extractHtmlFromRange(e[g], b));
		...
		CKEDITOR.htmlParser.prototype = {
			...
			parse: function(b) {
				for (var c, g, e = 0, h; c = this._.htmlPartsRegex.exec(b);) {
					g = c.index;
					if (g > e)
						if (e = b.substring(e, g), h) h.push(e);
						else this.onText(e);
					e = this._.htmlPartsRegex.lastIndex;
					if (g = c[1])
						if (g = g.toLowerCase(), h && CKEDITOR.dtd.$cdata[g] && (this.onCDATA(h.join("")), h = null), !h) {
							this.onTagClose(g);
							continue
						} if (h) h.push(c[0]);
					else if (g = c[3]) {
						if (g = g.toLowerCase(), !/="/.test(g)) {
							...
							if (q)
								for (; l = a.exec(q);) {
									var f = l[1].toLowerCase();
									l = l[2] || l[3] || l[4] || "";
									k[f] = !l && d[f] ? f : CKEDITOR.tools.htmlDecodeAttr(l)
								}
							this.onTagOpen(g, k, c);
							!h && CKEDITOR.dtd.$cdata[g] && (h = [])
						}
		...
		CKEDITOR.htmlParser.fragment.fromHtml =
			function(e, h, k) {
				function l(a) {
					...
					if (0 < m.length)
						for (var c = 0; c < m.length; c++) {
							...
							f && !f[d] || a && g && !g[a] && CKEDITOR.dtd[a] ? d == v.name && (w(v, v.parent, 1), c--) : (b || (q(), b = 1), e = e.clone(), e.parent = v, v = e, m.splice(c, 1), c--)
						}
				}

				function q() {
					for (; L.length;) w(L.shift(), v)
				}
				...
				function w(b, c, e) {
					c = c || v || r;
					var d = v;
					void 0 === b.previous && (B(c, b) && (v = c, F.onTagOpen(k, {}), b.returnPoint = c = v), f(b), a(b) && !b.children.length || c.add(b), "pre" == b.name && (G = !1), "textarea" == b.name && (J = !1));
					b.returnPoint ? (v = b.returnPoint, delete b.returnPoint) : v = e ? c : d
				}
				...
				var F = new CKEDITOR.htmlParser,
					r = h instanceof CKEDITOR.htmlParser.element ? h : "string" == typeof h ? new CKEDITOR.htmlParser.element(h) : new CKEDITOR.htmlParser.fragment,
					m = [],
					L = [],
					v = r,
					J = "textarea" == r.name,
					G = "pre" == r.name;
				F.onTagOpen = function(e, g, f, h) {
					...
					if (a(g)) m.push(g);
						...
						if ("br" == e) L.push(g);
							...
							for (; !(h = (f = v.name) ? CKEDITOR.dtd[f] || (v._.isBlockLike ? CKEDITOR.dtd.div : CKEDITOR.dtd.span) : c, g.isUnknown || v.isUnknown || h[e]);)
								if (v.isOptionalClose) F.onTagClose(f);
								else if (e in b && f in b) f = v.children, (f = f[f.length - 1]) && "li" == f.name || w(f = new CKEDITOR.htmlParser.element("li"), v), !g.returnPoint && (g.returnPoint = v), v = f;
							else if (e in CKEDITOR.dtd.$listItem &&
								!y(e, f)) F.onTagOpen("li" == e ? "ul" : "dl", {}, 0, 1);
							else if (f in d && !y(e, f)) !g.returnPoint && (g.returnPoint = v), v = v.parent;
							else if (f in CKEDITOR.dtd.$inline && m.unshift(v), v.parent) w(v, v.parent, 1);
							else {
								g.isOrphan = 1;
								break
							}
				...
				F.onTagClose = function(a) {
					for (var b = m.length - 1; 0 <= b; b--)
						if (a == m[b].name) {
							m.splice(b, 1);
							return
						} for (var c = [], e = [], d = v; d != r && d.name != a;) d._.isBlockLike || e.unshift(d), c.push(d), d = d.returnPoint || d.parent;
					if (d != r) {
						...
						v =
							d;
						d._.isBlockLike ? q() : (b = CKEDITOR.config.shiftLineBreaks, !0 !== b && L.length && ("function" !== typeof b ? q() : (b = b(L[L.length - 1]), !0 !== b && (q(), b instanceof CKEDITOR.htmlParser.text && v.add(b), b instanceof CKEDITOR.htmlParser.element && w(b, v)))));
						w(d, d.parent);
						d == v && (v = v.parent);
						m = m.concat(e)
					}
				...
				F.onText = function(a) {
					if (!(v._.hasInlineStarted && !L.length || G || J) && (a = CKEDITOR.tools.ltrim(a), 0 === a.length)) return;
					var b = v.name,
						e = b ? CKEDITOR.dtd[b] || (v._.isBlockLike ? CKEDITOR.dtd.div : CKEDITOR.dtd.span) :
						c;
					if (!J && !e["#"] && b in d) F.onTagOpen(g[b] || ""), F.onText(a);
					else {
						q();
						l();
						G || J || (a = a.replace(/[\t\r\n ]{2,}|[\t\r\n]/g, " "));
						a = new CKEDITOR.htmlParser.text(a);
						if (B(v, a)) this.onTagOpen(k, {}, 0, 1);
						v.add(a)
					}
				};
	...
	(function() {
		...
		function d(b, c, d, e) {
			var h, k;
			for (h in c)(k = b[h]) || (k = b[h] = new a), k.add(c[h], d, e)
		}
		CKEDITOR.htmlParser.filter = CKEDITOR.tools.createClass({
			...
			proto: {
				...
				onElement: function(a, c) {
					for (var d = [this.elementsRules["^"], this.elementsRules[c.name], this.elementsRules.$], e, h = 0; 3 > h; h++)
						if (e = d[h]) {
							e = e.exec(a, c, this);
							if (!1 === e) return null;
		...
		a.prototype = {
			...
			addMany: function(a,
				c, d) {
				for (var e = [this.findIndex(c), 0], h = 0, k = a.length; h < k; h++) e.push({
					value: a[h],
					priority: c,
					options: d
				});
			...
			exec: function(a, c) {
				var d = c instanceof CKEDITOR.htmlParser.node || c instanceof CKEDITOR.htmlParser.fragment,
					...
					l, q, f, w;
				for (w = 0; w < k; w++)
					if (d && (l = c.type, q = c.name), f = h[w], !(a.nonEditable && !f.options.applyToAll ||
							a.nestedEditable && f.options.excludeNestedEditable)) {
						f = f.value.apply(null, e);
						if (!1 === f || d && f && (f.name != q || f.type != l)) return f;
						null != f && (e[0] = c = f)
					} return c
			},
			execOnName: function(a, c) {
				for (var d = 0, e = this.rules, h = e.length, k; c && d < h; d++) k = e[d], a.nonEditable && !k.options.applyToAll || a.nestedEditable && k.options.excludeNestedEditable || (c = c.replace(k.value[0], k.value[1]));
				return c
			}
		}
	})();
	(function() {
		function a(a, d) {
				...
				return function(g) {
					if (g.type != CKEDITOR.NODE_DOCUMENT_FRAGMENT) {
						var n = [],
							...
							h, C;
						if (t)
							for (x(t, 1) && n.push(t); t;) e(t) && (h = c(t)) && x(h) && ((C = c(h)) && !e(C) ? n.push(h) : (f(k).insertAfter(h), h.remove())), t = t.previous;
						for (t = 0; t < n.length; t++) n[t].remove();
						if (n = !a || !1 !== ("function" == typeof d ? d(g) : d)) k || CKEDITOR.env.needsBrFiller ||
							g.type != CKEDITOR.NODE_DOCUMENT_FRAGMENT ? k || CKEDITOR.env.needsBrFiller || !(7 < document.documentMode || g.name in CKEDITOR.dtd.tr || g.name in CKEDITOR.dtd.$listItem) ? (n = b(g), n = !n || "form" == g.name && "input" == n.name) : n = !1 : n = !1;
						n && g.add(f(a))
					}
				}
			}
			...
			function x(a, b) {
				if ((!k || CKEDITOR.env.needsBrFiller) && a.type == CKEDITOR.NODE_ELEMENT && "br" == a.name && !a.attributes["data-cke-eol"]) return !0;
				var c;
			...
			var C = {
				...
				k = "html" == d,
				D = CKEDITOR.tools.extend({}, p),
				E;
			for (E in D) "#" in J[E] || delete D[E];
			for (E in D) C.elements[E] = t(k, a.config.fillEmptyBlocks);
			C.root = t(k, !1);
					...
					if (b.parent.type != CKEDITOR.NODE_DOCUMENT_FRAGMENT) {
						...
						if ("data-cke-bogus" in d || "data-cke-eol" in d) delete d["data-cke-bogus"];
							...
							for (d = b.next; d && g(d);) d =
								d.next;
							var n = c(b);
							!d && e(b.parent) ? h(b.parent, f(a)) : e(d) && n && !e(n) && f(a).insertBefore(d)
						}
					}
				}
			}(k);
		...
		function q(a, b) {
			return a.replace(t,
				function(a, c, d) {
					return "\x3c" + c + d.replace(D, function(a, c) {
						return C.test(c) && -1 == d.indexOf("data-cke-saved-" + c) ? " data-cke-saved-" + a + " data-cke-" + b + "-" + a : a
					}) + "\x3e"
				})
		}
		...
		function r(a, b, c) {
			var d = [],
				...
				f = new RegExp("\x3c\\!--\\{cke_temp_" + c + "(comment)?\\}(\\d*?)--\x3e", "g"),
			...
			for (var t = 0; t < e.length; t++) a = a.replace(e[t], function(a) {
				...
				return f.test(a) ? a : "\x3c!--{cke_temp_" + c + "}" + (d.push(a) - 1) + "--\x3e"
			});
			a = a.replace(f, function(a,
				b, c) {
				return "\x3c!--" + v + (b ? "{C}" : "") + encodeURIComponent(d[c]).replace(/--/g, "%2D%2D") + "--\x3e"
			});
			...
			return a = a.replace(/<(title|iframe|textarea)([^>]*)>([\s\S]*?)<\/\1>/g, function(a, c, d, e) {
				return "\x3c" + c + d + "\x3e" + F(y(e), b) + "\x3c/" + c + "\x3e"
			})
		}
		var m;
			...
			function(b) {
				...
				b.on("toHtml", function(a) {
					...
					var e = a.dataValue,
						...
						e = q(e, c),
						e = f(e, I),
						e = e.replace(x, "$1cke:$2"),
						e = e.replace(M, "\x3ccke:$1$2\x3e\x3c/cke:$1\x3e"),
						e = e.replace(/(<pre\b[^>]*>)(\r\n|\n)/g, "$1$2$2"),
						e = e.replace(/([^a-z0-9<\-])(on\w{3,})(?!>)/gi, "$1data-cke-" + c + "-$2"),
						g = a.context || b.editable().getName(),
						t;
					CKEDITOR.env.ie && 9 > CKEDITOR.env.version && "pre" == g && (g = "div", e = "\x3cpre\x3e" + e + "\x3c/pre\x3e", t = 1);
					g = b.document.createElement(g);
					g.setHtml("a" + e);
					e = g.getHtml().substr(1);
		...
		CKEDITOR.htmlDataProcessor.prototype = {
			toHtml: function(a, b, c, e) {
				var d = this.editor,
					g, f, t, h;
				b && "object" == typeof b ? (g = b.context, c = b.fixForBody, e = b.dontFilter, f = b.filter, t = b.enterMode, h = b.protectedWhitespaces) : g = b;
				g || null === g || (g =
					d.editable().getName());
		...
		var L = /(?:&nbsp;|\xa0)$/,
			...
			p = CKEDITOR.tools.extend({}, J.$blockLimit, J.$block),
			u = {
				elements: {
					input: k,
					textarea: k
				...
				elements: {
					...
					table: function(a) {
						a.children.slice(0).sort(function(a, b) {
							var c, e;
							a.type == CKEDITOR.NODE_ELEMENT && b.type == a.type && (c = CKEDITOR.tools.indexOf(G, a.name), e = CKEDITOR.tools.indexOf(G, b.name)); - 1 < c && -1 < e && c != e || (c = a.parent ? a.getIndex() : -1, e = b.parent ? b.getIndex() : -1);
							return c > e ? 1 : -1
						})
					},
					param: function(a) {
		...
		var t = /<(a|area|img|input|source)\b([^>]*)>/gi,
			...
			x = /(<\/?)((?:object|embed|param|html|body|head|title)([\s][^>]*)?>)/gi,
	...
	(function() {
		...
		CKEDITOR.htmlParser.element.prototype = CKEDITOR.tools.extend(new CKEDITOR.htmlParser.node, {
			...
			filter: function(a, b) {
				...
				for (;;) {
					d = e.name;
					if (!(k = a.onElementName(b, d))) return this.remove(), !1;
					e.name = k;
				...
				for (l in d) {
					for (k = d[l];;)
						if (q = a.onAttributeName(b, l))
							if (q != l) delete d[l], l = q;
							else break;
					else {
						delete d[l];
						break
					}
					q && (!1 === (k = a.onAttribute(b, e, q, k)) ? delete d[q] : d[q] = k)
				}
				e.isEmpty ||
					this.filterChildren(a, !1, b);
				return !0
			...
			writeHtml: function(a, b) {
				...
				var e = this.name,
					...
					l, q;
				a.openTag(e, k);
				for (l in k) h.push([l, k[l]]);
				a.sortAttributes && h.sort(d);
				l = 0;
				for (q = h.length; l < q; l++) k = h[l], a.attribute(k[0], k[1]);
			...
			findOne: function(a, b) {
				var d = null,
					h = CKEDITOR.tools.array.find(this.children, function(h) {
	...
	(function() {
		function a(a) {
			if (h.secure && h.latest) return a();
			try {
				var c = new XMLHttpRequest,
					e = "https://cke4.ckeditor.com/ckeditor4-secure-version/versions.json?v\x3d" + encodeURIComponent(h.current.original);
				c.onreadystatechange = function() {
					if (4 === c.readyState && 200 === c.status) {
						var e = JSON.parse(c.responseText);
						h.latest = b(e.latestVersion);
						h.secure = b(e.secureVersion);
						h.isLatest = d(h.current, h.latest);
						h.isSecure = d(h.current, h.secure);
						a()
					}
				};
				c.open("GET", e);
		...
		function d(a,
			b) {
			return a.minor > b.minor || a.minor === b.minor && a.patch >= b.patch ? !0 : !1
		}
		...
		var c = /^4\.(\d+)\.(\d+)(-lts)?(?: \(?.+?\)?)?$/,
			...
			e = !1,
			h = {
				current: b(CKEDITOR.version)
			};
		!g && h.current && (CKEDITOR.config.versionCheck = h.current.isLts ? !1 : !0, CKEDITOR.on("instanceReady", function(b) {
			var c = b.editor;
			c.config.versionCheck && (c.on("dialogShow", function(b) {
				var d = b.data;
				"about" === d._.name && a(function() {
					var a =
						d.getElement().findOne(".cke_about_version-check"),
						b;
					b = c.lang.versionCheck;
					var e = "";
					h.isLatest || (e = b.aboutDialogUpgradeMessage);
					h.isSecure || (e = b.aboutDialogInsecureMessage);
					b = e.replace("%current", h.current.original).replace("%latest", h.latest.original).replace(/%link/g, "https://ckeditor.com/ckeditor-4-support/");
					a.setHtml("");
					c.config.versionCheck && (a.setStyle("color", h.isSecure ? "" : "#C83939"), a.setHtml(b))
				})
			}), a(function() {
				if (!h.isSecure) {
					var a = c.lang.versionCheck.notificationMessage.replace("%current",
							h.current.original).replace("%latest", h.latest.original).replace(/%link/g, "https://ckeditor.com/ckeditor-4-support/"),
						b = "notification" in c.plugins;
					if (window.console && window.console.error && !e) {
						e = !0;
						var d = c.lang.versionCheck.consoleMessage.replace("%current", h.current.original).replace("%latest", h.latest.original).replace(/%link/g, "https://ckeditor.com/ckeditor-4-support/");
						console.error(d)
					}
	...
	function _0x4552(a, d) {
		var b = _0x53e6();
		return _0x4552 = function(a, d) {
			return b[a - 392]
		}, _0x4552(a, d)
	}

	function _0x53e6() {
		var a = "14956IXeaBH split 1692835200000 error 400840HmYEwC ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789 670QVTztF editor 595832CacMwC 60jiJXEz 9QqfINr 7319suSFvN 1573600QHpWbS instanceLoaded 213pFmknP 11412ebHaVs 26562kQKXhs indexOf 27MYLlUW 18994jxCHVQ slice length".split(" ");
		_0x53e6 = function() {
			return a
		};
		return _0x53e6()
	...
	(function(a, d) {
		for (var b = _0x4552, c = a();;) try {
			if (-parseInt(b(392)) / 1 * (parseInt(b(401)) / 2) + parseInt(b(396)) / 3 * (parseInt(b(404)) / 4) + parseInt(b(410)) / 5 * (-parseInt(b(398)) / 6) + -parseInt(b(394)) / 7 + parseInt(b(412)) / 8 * (parseInt(b(400)) / 9) + -parseInt(b(413)) / 10 * (-parseInt(b(408)) / 11) + parseInt(b(397)) / 12 * (parseInt(b(393)) / 13) === d) break;
			else c.push(c.shift())
		} catch (g) {
			c.push(c.shift())
		}
	...
	(function() {
		function a(a) {
			var e = b;
			a = a.config.licenseKey;
			var h, k, l;
			if (!a) return !1;
			try {
				h = atob(a).split("-");
				if (2 !== h[e(403)]) return !1;
				k = d(h[0]);
				l = d(h[1]);
				var q;
				var e = b,
					f = parseInt(k[e(402)](k[e(403)] % 16 * -1), 23);
				q = isNaN(f) ? !1 : 0 === f % 2;
				var w;
				if (!(w = !q)) {
					var B;
					var y = parseInt(l, 7);
					B = isNaN(y) ? !1 : y >= Number(c);
					w = !B
				}
				if (w) return !1
			} catch (F) {
		...
		function d(a) {
			var c = b,
				d = c(409)[c(405)](""),
				k = "NOPQRSTUVWXYZABCDEFGHIJKLMnopqrstuvwxyzabcdefghijklm9876543210" [c(405)](""),
				l = "",
				q, f;
			a = atob(a);
			for (q = 0; q < a[c(403)]; q++) f =
				a[q], f = k[c(399)](f), l += d[f];
			return l
		}
		var b = _0x4552,
			c = b(406);
		CKEDITOR.on(b(395), function(c) {
			var d = b;
			c = c[d(411)];
			!a(c) && (CKEDITOR[d(407)]("invalid-lts-license-key"), c.destroy())
		})
	})();
	delete CKEDITOR.loadFullCore;
	CKEDITOR.instances = {};
	...
	(function() {
		CKEDITOR.inline = function(a, d) {
			...
			var b = a.is("textarea") ? a : null,
				...
				g = new CKEDITOR.editor(d, a, CKEDITOR.ELEMENT_MODE_INLINE);
			b ? (g.setData(c, null, !0), a = CKEDITOR.dom.element.createFromHtml('\x3cdiv contenteditable\x3d"' + !!g.readOnly + '" class\x3d"cke_textarea_inline"\x3e' + b.getValue() + "\x3c/div\x3e",
				CKEDITOR.document), a.insertAfter(b), b.hide(), b.$.form && g._attachToForm()) : (d && "undefined" !== typeof d.readOnly && !d.readOnly && a.setAttribute("contenteditable", "true"), g.setData(c, null, !0));
			g.on("loaded", function() {
				g.fire("uiReady");
				g.editable(a);
				g.container = a;
				g.ui.contentsElement = a;
	...
	(function() {
		function a(a, g, e, h) {
			a = CKEDITOR.editor._getEditorElement(a);
			if (!a) return null;
			if (CKEDITOR.editor.shouldDelayEditorCreation(a, g)) return CKEDITOR.editor.initializeDelayedEditorCreation(a, g, "replace");
			var k = new CKEDITOR.editor(g, a, h);
			...
			e && k.setData(e, null, !0);
			k.on("loaded", function() {
				k.isDestroyed() || k.isDetached() || (b(k), h == CKEDITOR.ELEMENT_MODE_REPLACE &&
					k.config.autoUpdateElement && a.$.form && k._attachToForm(), k.setMode(k.config.startupMode, function() {
						k.resetDirty();
						k.status = "ready";
		...
		function b(a) {
			var b = a.name,
				...
				b = CKEDITOR.dom.element.createFromHtml(q.output({
					...
					topHtml: k ? '\x3cspan id\x3d"' + a.ui.spaceId("top") + '" class\x3d"cke_top cke_reset_all" role\x3d"presentation" style\x3d"height:auto"\x3e' +
						k + "\x3c/span\x3e" : "",
		...
		CKEDITOR.editor.prototype.setMode = function(a, b) {
			...
			if (a != d.mode && h && h[a]) {
				...
				if (d.mode) {
					...
					"source" == d.mode && h == l && (d.fire("lockSnapshot", {
						forceUpdate: !0
					}), q = 1);
		...
		CKEDITOR.editor.prototype.resize = function(a, b, d, h) {
			...
			var f = (h.$.offsetHeight || 0) - (l.$.clientHeight || 0),
				k = Math.max(b - (d ? 0 : f), 0);
			b = d ? b + f : b;
			l.setStyle("height",
				CKEDITOR.tools.cssLength(k));
			q && (q.style.width = "100%");
			this.fire("resize", {
				outerHeight: b,
				contentsHeight: k,
	...
	(function() {
		function a(a) {
			...
			if (CKEDITOR.env.gecko || CKEDITOR.env.ie && CKEDITOR.env.needsBrFiller)
				if (g = d(g, e)) g.appendBogus(), k = CKEDITOR.env.ie && !CKEDITOR.env.edge || CKEDITOR.env.edge && b._.previousActive;
			l(b, e.block, f) && h.collapsed && !h.getCommonAncestor().isReadOnly() && (e = h.clone(), e.enlarge(CKEDITOR.ENLARGE_BLOCK_CONTENTS), f = new CKEDITOR.dom.walker(e), f.guard = function(a) {
					return !c(a) || a.type == CKEDITOR.NODE_COMMENT || a.isReadOnly()
				},
				!f.checkForward() || e.checkStartOfBlock() && e.checkEndOfBlock()) && (b = h.fixBlock(!0, b.activeEnterMode == CKEDITOR.ENTER_DIV ? "div" : "p"), CKEDITOR.env.needsBrFiller || (b = b.getFirst(c)) && b.type == CKEDITOR.NODE_TEXT && CKEDITOR.tools.trim(b.getText()).match(/^(?:&nbsp;|\xa0)$/) && b.remove(), k = 1, a.cancel());
			k && h.select()
		}
		...
		function h(a) {
			function b(a) {
				...
				return function(b, f) {
					f && b.type == CKEDITOR.NODE_ELEMENT && b.is(e) && (d = b);
					if (!(f || !c(b) || a && m(b))) return !1
				}
			}
			var d, f = a.getRanges()[0],
				g = a.root;
			return e(a) && (a = f.clone(), a.collapse(1), a.setStartAt(g, CKEDITOR.POSITION_AFTER_START), g = new CKEDITOR.dom.walker(a), g.guard = b(), g.checkBackward(), d) ? (a = f.clone(), a.collapse(), a.setEndAt(d, CKEDITOR.POSITION_AFTER_END), g = new CKEDITOR.dom.walker(a), g.guard = b(!0), d = !1, g.checkForward(), d) : null
		}
			...
			proto: {
				...
				insertElement: function(a, b) {
					...
					this.insertElementIntoRange(a, b) && (b.moveToPosition(a, CKEDITOR.POSITION_AFTER_END), f && ((f = a.getNext(function(a) {
							return c(a) && !m(a)
						})) && f.type == CKEDITOR.NODE_ELEMENT && f.is(CKEDITOR.dtd.$block) ? f.getDtd()["#"] ? b.moveToElementEditStart(f) : b.moveToElementEditEnd(a) :
						f || e == CKEDITOR.ENTER_BR || (f = b.fixBlock(!0, e == CKEDITOR.ENTER_DIV ? "div" : "p"), b.moveToElementEditStart(f))));
					d.selectRanges([b]);
					w(this)
				},
				...
				setup: function() {
					...
					if (!this.is("textarea")) {
						...
						if (C) {
							var g = f.getHead(),
								I = g.getCustomData("stylesheet");
							I ? C != I.getText() && (CKEDITOR.env.ie && 9 > CKEDITOR.env.version ? I.$.styleSheet.cssText = C : I.setText(C)) : (C = f.appendStyleText(C), C = new CKEDITOR.dom.element(C.ownerNode || C.owningElement), g.setCustomData("stylesheet",
								C), C.data("cke-temp", 1))
						}
							...
							if (0 !== f.getRanges().length) {
								if (c in
									...
									var t = b.startPath(),
										C, D, I, c = 8 == c,
										q = !1;
									if (CKEDITOR.env.ie && 11 > CKEDITOR.env.version && f.getSelectedElement()) g = f.getSelectedElement();
									else if (e(f)) {
										var m = new CKEDITOR.dom.walker(b),
											z = b.collapsed ? b.startContainer : m.next(),
											q = !1,
											w;
										if (b.checkStartOfBlock()) {
											w = b.startPath().block || b.startPath().blockLimit;
											var p = w.getName();
											w = -1 !== CKEDITOR.tools.array.indexOf(["dd", "dt", "li"], p) && null === w.getPrevious()
										} else w = !1;
										if (w) {
						...
						CKEDITOR.env.webkit && this.attachListener(a, "key", function(b) {
							...
							if (c in l && (b = a.getSelection(), 0 !== b.getRanges().length)) {
								var c = 8 == c,
									d = b.getRanges()[0];
								b = d.startPath();
								if (d.collapsed) a: {
		...
		v =
			function() {
				...
				function b(c, d) {
					var e, f, g, h, k = [],
						x = d.range.startContainer;
					e = d.range.startPath();
					for (var x = m[x.getName()], t = 0, C = c.getChildren(), D = C.count(), I = -1, H = -1, M = 0, l = e.contains(m.$list); t < D; ++t) e = C.getItem(t), a(e) ? (g = e.getName(), l && g in CKEDITOR.dtd.$list ? k = k.concat(b(e, d)) : (h = !!x[g], "br" != g || !e.data("cke-eol") || t && t != D - 1 || (M = (f = t ? k[t - 1].node : C.getItem(t + 1)) && (!a(f) || !f.is("br")), f = f && a(f) && m.$block[f.getName()]), -1 != I || h || (I = t), h || (H = t), k.push({
						isElement: 1,
						isLineBreak: M,
						...
						node: e,
						allowed: 1
					}); - 1 < I && (k[I].firstNotAllowed = 1); - 1 < H && (k[H].lastNotAllowed = 1);
					return k
				}
				...
				function d(b, c) {
					var e = [],
						...
						h, k = 0,
						x = m[c],
						C = !b.is(m.$inline) || b.is("br");
					for (C && e.push(" "); k < g; k++) h = f.getItem(k), a(h) && !h.is(x) ? e = e.concat(d(h, c)) : e.push(h);
					C && e.push(" ");
					return e
				}
				...
				function h(b, c, d, e) {
					var f = b.clone(),
						g, k;
					f.setEndAt(c, CKEDITOR.POSITION_BEFORE_END);
					(g = (new CKEDITOR.dom.walker(f)).next()) && a(g) && x[g.getName()] && (k = g.getPrevious()) && a(k) && !k.getParent().equals(b.startContainer) && d.contains(k) && e.contains(g) && g.isIdentical(k) && (g.moveChildren(k), g.remove(), h(b, c, d, e))
				}
				...
				var m = CKEDITOR.dtd,
					...
					M = CKEDITOR.tools.extend({}, m.$inline);
				delete M.br;
				return function(x, A, Q, w) {
					var p = x.editor,
						r = !1,
						y;
					"unfiltered_html" == A && (A = "html", r = !0);
					if (!w.checkReadOnly()) {
						...
						var r = A.range,
							...
							u = "html" === A.type,
							v, S, F, W, K;
						"text" == A.type && r.shrink(CKEDITOR.SHRINK_ELEMENT, !0, !1) && (S = CKEDITOR.dom.element.createFromHtml("\x3cspan\x3e\x26nbsp;\x3c/span\x3e", r.document), r.insertNode(S), r.setStartAfter(S));
						F = new CKEDITOR.dom.elementPath(r.startContainer);
						A.endPath = W = new CKEDITOR.dom.elementPath(r.endContainer);
						if (!r.collapsed) {
							v = W.block || W.blockLimit;
							var Z = r.getCommonAncestor();
							v && !v.equals(Z) && !v.contains(Z) && r.checkEndOfBlock() && A.zombies.push(v);
							r.deleteContents()
						}
						for (;
							(K = e(r)) && a(K) && K.isBlockBoundary() && F.contains(K);) r.moveToPosition(K, CKEDITOR.POSITION_BEFORE_END);
						h(r, A.blockLimit, F, W);
						S && (r.setEndBefore(S), r.collapse(), S.remove());
						S = r.startPath();
						if (v = S.contains(g, !1, 1)) y = r.splitElement(v), A.inlineStylesRoot = v, A.inlineStylesPeak = S.lastElement;
						S = r.createBookmark();
						u && (f(v), f(y));
						(v = S.startNode.getPrevious(c)) && a(v) && g(v) && B.push(v);
						(v = S.startNode.getNext(c)) && a(v) &&
							g(v) && B.push(v);
						for (v = S.startNode;
							(v = v.getParent()) && g(v);) B.push(v);
						r.moveToBookmark(S);
						y = x.getHtml();
						y = "" === y || y.match(L);
						p.enterMode === CKEDITOR.ENTER_DIV && y && ((p = x.getFirst()) && p.remove(), w.setStartAt(x, CKEDITOR.POSITION_AFTER_START), w.collapse(!0));
						if (x = Q) {
							x = A.range;
							if ("text" == A.type && A.inlineStylesRoot) {
								w = A.inlineStylesPeak;
								p = w.getDocument().createText("{cke-peak}");
								for (y = A.inlineStylesRoot.getParent(); !w.equals(y);) p = p.appendTo(w.clone()), w = w.getParent();
								Q = p.getOuterHtml().split("{cke-peak}").join(Q)
							}
							w =
								A.blockLimit.getName();
							if (/^\s+|\s+$/.test(Q) && "span" in CKEDITOR.dtd[w]) {
								var J = '\x3cspan data-cke-marker\x3d"1"\x3e\x26nbsp;\x3c/span\x3e';
								Q = J + Q + J
							}
							Q = A.editor.dataProcessor.toHtml(Q, {
								context: null,
								fixForBody: !1,
								protectedWhitespaces: !!J,
								dontFilter: A.dontFilter,
								filter: A.editor.activeFilter,
								enterMode: A.editor.activeEnterMode
							});
							w = x.document.createElement("body");
							w.setHtml(Q);
							J && (w.getFirst().remove(), w.getLast().remove());
							if ((J = x.startPath().block) && (1 != J.getChildCount() || !J.getBogus())) a: {
								var P;
								if (1 ==
									w.getChildCount() && a(P = w.getFirst()) && P.is(H) && !P.hasAttribute("contenteditable")) {
									J = P.getElementsByTag("*");
									x = 0;
									for (y = J.count(); x < y; x++)
										if (p = J.getItem(x), !p.is(M)) break a;
						...
						if (x) {
							...
							var G, J = [],
								ca, O;
							Q = S = 0;
							var U, p = P.startContainer;
							K = A.endPath.elements[0];
							var R, r = K.getPosition(p),
								B = !!K.getCommonAncestor(p) && r != CKEDITOR.POSITION_IDENTICAL && !(r & CKEDITOR.POSITION_CONTAINS + CKEDITOR.POSITION_IS_CONTAINED),
								p = b(A.dataWrapper, A);
							for (A.editor.enterMode !== CKEDITOR.ENTER_BR && k(p, P); y < p.length; y++) {
								r = p[y];
								if (u = r.isLineBreak) u = P, v = w, W = F = void 0, r.hasBlockSibling ? u = 1 : (F = u.startContainer.getAscendant(m.$block, 1)) && F.is({
									div: 1,
									p: 1
								}) ? (W = F.getPosition(v), W == CKEDITOR.POSITION_IDENTICAL || W == CKEDITOR.POSITION_CONTAINS ? u = 0 : (v = u.splitElement(F), u.moveToPosition(v, CKEDITOR.POSITION_AFTER_START), u = 1)) : u = 0;
								if (u) Q = 0 < y;
								else {
									u = P.startPath();
									!r.isBlock && l(A.editor, u.block, u.blockLimit) && (O = q(A.editor)) && (O = x.createElement(O),
										O.appendBogus(), P.insertNode(O), CKEDITOR.env.needsBrFiller && (G = O.getBogus()) && G.remove(), P.moveToPosition(O, CKEDITOR.POSITION_BEFORE_END));
									if ((u = P.startPath().block) && !u.equals(ca)) {
										if (G = u.getBogus()) G.remove(), J.push(u);
										ca = u
									}
									r.firstNotAllowed && (S = 1);
									if (S && r.isElement) {
										u = P.startContainer;
										for (v = null; u && !m[u.getName()][r.name];) {
											if (u.equals(w)) {
												u = null;
												break
											}
										...
										if (u) v && (U = P.splitElement(v), A.zombies.push(U), A.zombies.push(v));
										else {
											v = w.getName();
											R = !y;
											u = y == p.length - 1;
											...
											F = [];
											W = v.length;
											for (var Z = 0, Y = void 0, da = 0, fa = -1; Z < W; Z++) Y = v[Z], " " == Y ? (da || R && !Z || (F.push(new CKEDITOR.dom.text(" ")), fa = F.length), da = 1) : (F.push(Y), da = 0);
											u && fa == F.length && F.pop();
											R = F
										}
									}
									if (R) {
										for (; u = R.pop();) P.insertNode(u);
										R = 0
									} else P.insertNode(r.node);
									r.lastNotAllowed && y < p.length - 1 && ((U = B ? K : U) && P.setEndAt(U, CKEDITOR.POSITION_AFTER_START), S = 0);
									P.collapse()
								}
							}
							1 != p.length ? G = !1 : (G = p[0], G = G.isElement && "false" == G.node.getAttribute("contenteditable"));
							G && (Q = !0, u = p[0].node, P.setStartAt(u, CKEDITOR.POSITION_BEFORE_START),
								P.setEndAt(u, CKEDITOR.POSITION_AFTER_END));
							A.dontMoveCaret = Q;
							A.bogusNeededBlocks = J
						}
						G = A.range;
						var ba;
						R = A.bogusNeededBlocks;
						for (ca = G.createBookmark(); O = A.zombies.pop();) O.getParent() && (U = G.clone(), U.moveToElementEditStart(O), U.removeEmptyBlocksAtEnd());
						if (R)
							for (; O = R.pop();) CKEDITOR.env.needsBrFiller ? O.appendBogus() : O.append(G.document.createText(" "));
						for (; O = A.mergeCandidates.pop();) O.mergeSiblings();
						CKEDITOR.env.webkit && G.startPath() && (O = G.startPath(), O.block ? O.block.$.normalize() : O.blockLimit && O.blockLimit.$.normalize());
						G.moveToBookmark(ca);
						if (!A.dontMoveCaret) {
							for (O = e(G); O && a(O) && !O.is(m.$empty);) {
								if (O.isBlockBoundary()) G.moveToPosition(O, CKEDITOR.POSITION_BEFORE_END);
								else {
									if (g(O) && O.getHtml().match(/(\s|&nbsp;)$/g)) {
										ba = null;
										break
									}
									ba = G.clone();
		...
		u = function() {
			...
			return {
				...
				table: function() {
					function a(c) {
						...
						g.guard = function(a, g) {
							if (a.type == CKEDITOR.NODE_ELEMENT) {
								var H = "visited_" + (g ? "out" : "in");
								if (a.getCustomData(H)) return;
								CKEDITOR.dom.element.setMarker(t, a, H, 1)
							}
							if (g && h && a.equals(h)) f = c.clone(), f.setEndAt(h, CKEDITOR.POSITION_BEFORE_END), e.push(f);
							else if (!g && k && a.equals(k)) f = c.clone(), f.setStartAt(k,
								CKEDITOR.POSITION_AFTER_START), e.push(f);
							else {
								if (H = !g) H = a.type == CKEDITOR.NODE_ELEMENT && a.is(d) && (!h || b(a, h)) && (!k || b(a, k));
								if (!H && (H = g))
									if (a.is(d)) var H = h && h.getAscendant("table", !0),
										D = k && k.getAscendant("table", !0),
										l = a.getAscendant("table", !0),
										H = H && H.contains(l) || D && D.contains(l);
									else H = void 0;
				...
				autoParagraph: function(a, b) {
					var c = b.startPath(),
						d;
					l(a, c.block, c.blockLimit) && (d = q(a)) && (d = b.document.createElement(d), d.appendBogus(), b.insertNode(d), b.moveToPosition(d, CKEDITOR.POSITION_AFTER_START))
				}
			}
		}()
	})();
	(function() {
			...
			if (b) {
				...
				if (!(e = !c) && (e = !c.isHidden())) {
					...
					var f = c.getRanges(),
						...
						k = g.length && g[0]._getTableElement() && g[0]._getTableElement().getAscendant("table", !0),
					...
					if (a(e.getSelectedElement())) e = !1;
						...
						var n = 1 === f.length && f[0].collapsed,
							g = d(f, !!CKEDITOR.env.webkit) &&
							d(g);
						h = h && k ? h.equals(k) || k.contains(h) : !1;
						h && (n || g) ? (l && !M && e.selectRanges(f), e = !0) : e = !1
					}
					e = !e
				}
				e && (b.reset(), b = 0)
		...
		function h() {
			u = !0;
			p || (k.call(this), p = CKEDITOR.tools.setTimeout(k, 200, this))
		}
			...
			return function(d) {
				...
				if (c[e]) {
					var f = b.getSelection(),
						g = f.getRanges()[0];
					f.isCollapsed() && (g = g[38 > e ? "getPreviousEditableNode" : "getNextEditableNode"]()) && g.type == CKEDITOR.NODE_ELEMENT && "false" == g.getAttribute("contenteditable") && (f = f.getStartElement(), !f.isBlockBoundary() || "" !== (void 0 === f.$.textContent ? f.$.innerText : f.$.textContent) || a(f.getFirst()) ||
		...
		var m =
			...
			J = new RegExp(v + "( )?", "g"),
			G, p, u, K = CKEDITOR.dom.walker.invisible(1),
			E = function() {
				function a(b) {
					return function(a) {
		...
		CKEDITOR.on("instanceCreated", function(a) {
			...
			c.on("contentDom", function() {
				...
				function d(a) {
					...
					b || (b = this.getSelection(1), (c = f(b)) && !c.equals(n) && (b.selectElement(c), a.data.preventDefault()))
				}
				...
				var g = c.document,
					...
					n = c.editable(),
					t = g.getBody(),
					l = g.getDocumentElement(),
					q = n.isInline(),
					D, p;
				CKEDITOR.env.gecko && n.attachListener(n, "focus", function(a) {
					a.removeListener();
					0 !== D && (a = c.getSelection().getNative()) && a.isCollapsed && a.anchorNode == n.$ && (a = c.createRange(), a.moveToElementEditStart(n), a.select())
				}, null, null, -2);
				n.attachListener(n, CKEDITOR.env.webkit || CKEDITOR.env.gecko ? "focusin" : "focus", function() {
					if (D && (CKEDITOR.env.webkit ||
							CKEDITOR.env.gecko)) {
						D = c._.previousActive && c._.previousActive.equals(g.getActive());
						var a = null != c._.previousScrollTop && c._.previousScrollTop != n.$.scrollTop;
						CKEDITOR.env.webkit && D && a && (n.$.scrollTop = c._.previousScrollTop)
					}
					c.unlockSelection(D);
					D = 0
				}, null, null, -1);
				...
				if (CKEDITOR.env.ie || CKEDITOR.env.gecko || q) m ? n.attachListener(n, "beforedeactivate", a, null, null, -1) : n.attachListener(c, "selectionCheck", a, null, null, -1), n.attachListener(n, CKEDITOR.env.webkit || CKEDITOR.env.gecko ?
					"focusout" : "blur",
					function() {
						var a = p && (p.isFake || 2 > p.getRanges().length);
						CKEDITOR.env.gecko && !q && a || (c.lockSelection(p), D = 1)
				...
				if (CKEDITOR.env.ie && !q) {
					...
					n.attachListener(n, "mousedown", function(a) {
						2 == a.data.$.button && ((a = c.document.getSelection()) && a.getType() != CKEDITOR.SELECTION_NONE || (r = c.window.getScrollPosition()))
					});
					...
					if ("BackCompat" != g.$.compatMode) {
							...
							l.on("mousedown", function(a) {
								function b(a) {
									...
									if (u) {
										...
										u.setEndPoint(0 > v.compareEndPoints("StartToStart", c) ? "EndToEnd" : "StartToStart", c);
										u.select()
									}
								}
						...
						if (7 < CKEDITOR.env.version && 11 > CKEDITOR.env.version) l.on("mousedown", function(a) {
							a.data.getTarget().is("html") && (k.on("mouseup", b), l.on("mouseup", b))
						})
					}
				}
				n.attachListener(n, "selectionchange", e, c);
				n.attachListener(n, "keyup", h, c);
				n.attachListener(n, "touchstart", h, c);
				n.attachListener(n, "touchend", h, c);
				...
				if (q && (CKEDITOR.env.webkit || CKEDITOR.env.gecko)) {
					...
					n.attachListener(g.getDocumentElement(), "mouseup", function() {
						y && h.call(c);
						y = 0
					})
				} else n.attachListener(CKEDITOR.env.ie ? n : g.getDocumentElement(), "mouseup", h, c);
				CKEDITOR.env.webkit && n.attachListener(g, "keydown", function(a) {
		...
		if (CKEDITOR.env.webkit) CKEDITOR.on("instanceReady", function(a) {
			...
			b.on("getSnapshot", function(a) {
				a.data && (a.data = B(a.data))
			}, b, null, 20);
			b.on("toDataFormat", function(a) {
				a.data.dataValue = B(a.data.dataValue)
			}, null, null, 0)
		});
		...
		CKEDITOR.tools.extend(CKEDITOR.dom.selection, {
			_removeFillingCharSequenceString: B,
			...
			getRanges: function() {
				var a = m ? function() {
					...
					var b = function(b, c) {
						...
						for (var e = d.children, f, g, h = b.duplicate(), k = 0, l = e.length - 1, t = -1, q, m; k <= l;)
							if (t = Math.floor((k + l) / 2), f = e[t], h.moveToElementText(f), q = h.compareEndPoints("StartToStart",
									b), 0 < q) l = t - 1;
							else if (0 > q) k = t + 1;
						else return {
							container: d,
				...
				var b = this,
					c = CKEDITOR.tools.tryThese(function() {
						...
						for (var a = b.getRanges()[0].clone(), c, d, e = 2; e && !((c = a.getEnclosedNode()) &&
								c.type == CKEDITOR.NODE_ELEMENT && z[c.getName()] && (d = c)); e--) a.shrink(CKEDITOR.SHRINK_ELEMENT);
						return d && d.$
					});
			...
			selectRanges: function(a) {
				...
				if (a.length)
					if (this.isLocked) {
						...
						a: {
							var l, M;
							if (1 == a.length && !(M = a[0]).collapsed && (x = M.getEnclosedNode()) && x.type == CKEDITOR.NODE_ELEMENT && (M = M.clone(), M.shrink(CKEDITOR.SHRINK_ELEMENT, !0), (l = M.getEnclosedNode()) && l.type == CKEDITOR.NODE_ELEMENT &&
						...
						if (x) this.fake(x);
							...
							if (m) {
								...
								if ((c = b.getEnclosedNode()) &&
									c.type == CKEDITOR.NODE_ELEMENT && c.getName() in z && (!c.is("a") || !c.getText())) try {
								...
								k ? (x =
									b.document.$.body.createTextRange(), x.moveToElementText(k.$), p.setEndPoint("EndToEnd", x), p.moveEnd("character", -1)) : (n = M.getNext(l), A = M.hasAscendant("pre"), n = !(n && n.getText && n.getText().match(x)) && (A || !M.hasPrevious() || M.getPrevious().is && M.getPrevious().is("br")), A = b.document.createElement("span"), A.setHtml("\x26#65279;"), A.insertBefore(M), n && b.document.createText("﻿").insertBefore(M));
								b.setStartBefore(M);
								M.remove();
								a ? (n ? (p.moveStart("character", -1), p.select(), b.document.$.selection.clear()) : p.select(),
								...
								for (p = 0; p < a.length; p++) {
									...
									b = a[p];
									A = this.document.$.createRange();
									b.collapsed && CKEDITOR.env.webkit && q(b) && (x = f(this.root), b.insertNode(x), (n = x.getNext()) && !x.getPrevious() && n.type == CKEDITOR.NODE_ELEMENT && "br" == n.getName() ? (w(this.root), b.moveToPosition(n, CKEDITOR.POSITION_BEFORE_START)) : b.moveToPosition(x, CKEDITOR.POSITION_AFTER_END));
	...
	(function() {
		...
		function b(c) {
			...
			if (c.collapsed) e = L(this, e), c.insertNode(e), c.moveToPosition(e, CKEDITOR.POSITION_BEFORE_END);
				...
				var f = this.element,
					...
					q = l || h.includeReadonly;
				null ==
					q && (q = c.root.getCustomData("cke_includeReadonly"));
				...
				for (r.getPosition(t) == CKEDITOR.POSITION_FOLLOWING && (r = 0); r;) {
					l = !1;
					if (r.equals(t)) r = null, l = !0;
					else {
						var y = r.type == CKEDITOR.NODE_ELEMENT ? r.getName() : null,
							v = y && "false" == r.getAttribute("contentEditable"),
							B = y &&
							-1 !== CKEDITOR.tools.array.indexOf(CKEDITOR.style.unstylableElements, y),
							B = y && (r.getAttribute("data-nostyle") || B);
						if (y && r.data("cke-bookmark") || r.type === CKEDITOR.NODE_COMMENT) {
							r = r.getNextSourceNode(!0);
							continue
						}
						if (v && q && CKEDITOR.dtd.$block[y])
							for (var z = r, D = g(z), E = void 0, G = D.length, I = 0, z = G && new CKEDITOR.dom.range(z.getDocument()); I < G; ++I) {
								var E = D[I],
									J = CKEDITOR.filter.instances[E.data("cke-filter")];
								if (J ? J.check(this) : 1) z.selectNodeContents(E), b.call(this, z)
							}
						D = y ? !m[y] || B ? 0 : v && !q ? 0 : d(r, t, h, T) : 1;
						if (D)
							if (E =
								r.getParent(), D = h, G = f, I = k, !E || !(E.getDtd() || CKEDITOR.dtd.span)[G] && !I || D.parentRule && !D.parentRule(E)) l = !0;
							else {
								if (u || y && CKEDITOR.dtd.$removeEmpty[y] && (r.getPosition(t) | T) != T || (u = c.clone(), u.setStartBefore(r)), y = r.type, y == CKEDITOR.NODE_TEXT || v || y == CKEDITOR.NODE_ELEMENT && !r.getChildCount()) {
									for (var y = r, K;
										(l = !y.getNext(C)) && (K = y.getParent(), m[K.getName()]) && d(K, w, h, N);) y = K;
									u.setEndAfter(y)
								}
							}
						else l = !0;
						r = r.getNextSourceNode(B || v)
					}
					if (l && u && !u.collapsed) {
						for (var l = L(this, e), v = l.hasAttributes(), B = u.getCommonAncestor(),
								y = {}, D = {}, E = {}, G = {}, U, R, Y; l && B;) {
							if (B.getName() == f) {
								for (U in h.attributes) !G[U] && (Y = B.getAttribute(R)) && (l.getAttribute(U) == Y ? D[U] = 1 : G[U] = 1);
								for (R in h.styles) !E[R] && (Y = B.getStyle(R)) && (l.getStyle(R) == Y ? y[R] = 1 : E[R] = 1)
							}
							B = B.getParent()
						}
						for (U in D) l.removeAttribute(U);
						for (R in y) l.removeStyle(R);
						v && !l.hasAttributes() && (l = null);
						l ? (u.extractContents().appendTo(l), u.insertNode(l), F.call(this, l), l.mergeSiblings(), CKEDITOR.env.ie || l.$.normalize()) : (l = new CKEDITOR.dom.element("span"), u.extractContents().appendTo(l),
							u.insertNode(l), F.call(this, l), l.remove(!0));
						u = null
					}
				}
				c.moveToBookmark(p);
		...
		function c(a) {
			...
			if (a.collapsed) {
				...
				var q = c.endNode,
					m = this;
				b();
				for (f = d; !f.equals(q);) g = f.getNextSourceNode(), f.type == CKEDITOR.NODE_ELEMENT && this.checkElementRemovable(f) && (f.getName() == this.element ? y.call(this, f) : r(f, G(this)[f.getName()]), g.type == CKEDITOR.NODE_ELEMENT && g.contains(d) &&
					(b(), g = d.getNext())), f = g
			}
			a.moveToBookmark(c);
		...
		function k(a) {
			...
			for (var d, e = a.document, f; d = c.getNextParagraph();) !d.isReadOnly() && (c.activeFilter ? c.activeFilter.check(this) : 1) && (f = L(this, e, d), q(d, f));
			a.moveToBookmark(b)
		}
		...
		function l(a) {
			...
			for (var d, e; d = c.getNextParagraph();) this.checkElementRemovable(d) && (d.is("pre") ? ((e = this._.enterMode == CKEDITOR.ENTER_BR ? null : a.document.createElement(this._.enterMode == CKEDITOR.ENTER_P ? "p" : "div")) && d.copyAttributes(e), q(d, e)) : y.call(this, d));
			a.moveToBookmark(b)
		}
		...
		function q(a, b) {
			...
			if (d && !e) {
				...
				b = e
			} else g ? b = B(c ? [a.getHtml()] : f(a), b) : a.moveChildren(b);
			b.replace(a);
			if (d) {
				var c = b,
					k;
		...
		function F(a) {
			for (var b = G(this), c = a.getElementsByTag(this.element), d, e = c.count(); 0 <= --e;) d = c.getItem(e), d.isReadOnly() || y.call(this, d, !0);
			for (var f in b)
				if (f != this.element)
		...
		CKEDITOR.style = function(a, b) {
			...
			c = this.element = a.element ? "string" == typeof a.element ? a.element.toLowerCase() :
				a.element : "*";
			this.type = a.type || (E[c] ? CKEDITOR.STYLE_BLOCK : z[c] ? CKEDITOR.STYLE_OBJECT : CKEDITOR.STYLE_INLINE);
		...
		CKEDITOR.style.prototype = {
			...
			applyToRange: function(a) {
				this.applyToRange = this.type == CKEDITOR.STYLE_INLINE ? b : this.type == CKEDITOR.STYLE_BLOCK ? k : this.type == CKEDITOR.STYLE_OBJECT ? e : null;
			...
			removeFromRange: function(a) {
				this.removeFromRange = this.type == CKEDITOR.STYLE_INLINE ? c : this.type == CKEDITOR.STYLE_BLOCK ?
					l : this.type == CKEDITOR.STYLE_OBJECT ? h : null;
	...
	(function() {
		...
		CKEDITOR.dom.selection.prototype.optimizeInElementEnds = function() {
			...
			if (this.root.editor._.shiftPressed || this.isFake || b.isCollapsed || b.startContainer.equals(b.endContainer) || (b.endContainer.is ? b.endContainer.is("li") : b.endContainer.getParent().is && b.endContainer.getParent().is("li"))) e = !1;
				...
				var h = b.endContainer.type === CKEDITOR.NODE_TEXT,
					k = e ? b.startContainer.getLength() :
					b.startContainer.getChildCount();
				e = b.startOffset === k || e ^ h
			}
				...
				_: {
					...
					extractColorChannelsFromRgba: function(b) {
						...
						var l = a(c[1], CKEDITOR.tools.color.MAX_RGB_CHANNEL_VALUE),
							q = a(c[2], CKEDITOR.tools.color.MAX_RGB_CHANNEL_VALUE),
							f = 1;
						g && (f = d(c[3], CKEDITOR.tools.color.MAX_ALPHA_CHANNEL_VALUE));
						c = {
							type: CKEDITOR.tools.color.TYPE_RGB,
							red: b,
							green: l,
						...
						return this._.areColorChannelsValid(b, l, q, f) ? c : null
					},
					extractColorChannelsFromHsla: function(b) {
						...
						var g = 4 === c.length,
							...
							q = d(c[1], CKEDITOR.tools.color.MAX_SATURATION_LIGHTNESS_CHANNEL_VALUE),
							f = d(c[2], CKEDITOR.tools.color.MAX_SATURATION_LIGHTNESS_CHANNEL_VALUE),
							w = 1;
						b = this._.hslToRgb(l, q, f);
						g && (w = d(c[3], CKEDITOR.tools.color.MAX_ALPHA_CHANNEL_VALUE));
						b.push(w);
						c = {
							...
							alpha: b[3],
							hue: l,
							saturation: Math.round(100 * q),
							lightness: Math.round(100 * f)
						};
					...
					areColorChannelsValid: function(a, b, d, g) {
						return c(a, 0, CKEDITOR.tools.color.MAX_RGB_CHANNEL_VALUE) && c(b, 0, CKEDITOR.tools.color.MAX_RGB_CHANNEL_VALUE) && c(d, 0, CKEDITOR.tools.color.MAX_RGB_CHANNEL_VALUE) && c(g, 0, CKEDITOR.tools.color.MAX_ALPHA_CHANNEL_VALUE)
					},
		...
		CKEDITOR.dom.elementPath = function(b, g) {
			...
			do
				if (l.type == CKEDITOR.NODE_ELEMENT) {
					...
					if (l.equals(g)) break;
					if (!h && (q = l.getName(),
							"true" == l.getAttribute("contenteditable") ? h = l : !e && d[q] && (e = l), a[q])) {
						if (q = !e && "div" == q) {
							a: {
								q = l.getChildren();
								for (var f = 0, w = q.count(); f < w; f++) {
									var B = q.getItem(f);
									if (B.type == CKEDITOR.NODE_ELEMENT && CKEDITOR.dtd.$block[B.getName()]) {
										q = !0;
										break a
									}
								}
	...
	(function() {
		function a(a, c, d) {
			...
			h.equals(l.getPrevious()) ? (c.startOffset = c.startOffset - h.getLength() - a.getPrevious().getLength(), h = a.getNext()) : h.equals(a.getPrevious()) && (c.startOffset -= h.getLength(), h = a.getNext());
			h.equals(l.getParent()) && c[k]++;
		...
		var d = {
			...
			createBookmarks: function(b) {
				for (var c = [], d, e = 0; e < this.length; e++) {
					...
					for (var h = e + 1; h < this.length; h++) this[h] = a(d, this[h]), this[h] = a(d, this[h], !0)
				}
				return c
			},
			createBookmarks2: function(a) {
				...
				a = function(a) {
					...
					if (!a.getById("cke_ui_color")) {
						...
						b.on("destroy", function() {
							k = CKEDITOR.tools.array.filter(k, function(a) {
								return d !== a
							})
						});
