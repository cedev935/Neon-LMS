...
@else
    ...
    <!-- Check if the language is set to RTL, so apply the RTL layouts -->
        ...
        <link rel="stylesheet" href="{{asset('assets/css/owl.carousel.css')}}?t={{ time() }}">
        <link rel="stylesheet" href="{{asset('assets/css/fontawesome-all.css')}}?t={{ time() }}">
        <link rel="stylesheet" href="{{asset('assets/css/flaticon.css')}}?t={{ time() }}">
        <link rel="stylesheet" type="text/css" href="{{asset('assets/css/meanmenu.css')}}?t={{ time() }}">
        <link rel="stylesheet" href="{{asset('assets/css/bootstrap.min.css')}}?t={{ time() }}">
        <link rel="stylesheet" href="{{asset('assets/css/video.min.css')}}?t={{ time() }}">
        <link rel="stylesheet" href="{{asset('assets/css/lightbox.css')}}?t={{ time() }}">
        <link rel="stylesheet" href="{{asset('assets/css/progess.css')}}?t={{ time() }}">
        <link rel="stylesheet" href="{{asset('assets/css/animate.min.css')}}?t={{ time() }}">
