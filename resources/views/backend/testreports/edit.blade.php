    ...
    <div class="card">
        <div class="card-header">
            ...
            <div class="float-right">
                <a href="{{ route('admin.testreports.index') }}"
                   class="btn btn-success">@lang('labels.backend.reports.title')</a>
            </div>
        </div>
        ...
        <div class="card-body">
            <div class="row">         
                ...
                <div class="col-12 form-group">
                    {!! Form::label('tests_id', 'Test', ['class' => 'control-label']) !!}
                    <?php 
                        $i=0;
                    ?>                 
            ...
            <div class="row">
                <div class="col-12 form-group" id="editor">
                    <textarea class="form-control" id="content-ckeditor" name="content">{{$current_content}}</textarea>
                </div>
            </div>
                ...
                <div class="col-12 col-lg-3 form-group">
                    <div class="checkbox">
                        <label for="published" class="checkbox control-label font-weight-bold">
                            <input id="published" name="published" type="checkbox" value="1" @if($testreport[0]->published) checked @endif>
                            Published
                        </label>                        
                    </div>
                </div>
